...
public class ac extends RecyclerView.q {
    ...
    protected int getHorizontalSnapPreference() {
        if (this.mTargetVector == null || this.mTargetVector.x == BitmapDescriptorFactory.HUE_RED) {
            return 0;
        }
        return this.mTargetVector.x > BitmapDescriptorFactory.HUE_RED ? 1 : -1;
    }

    protected int getVerticalSnapPreference() {
        if (this.mTargetVector == null || this.mTargetVector.y == BitmapDescriptorFactory.HUE_RED) {
            return 0;
        }
        return this.mTargetVector.y > BitmapDescriptorFactory.HUE_RED ? 1 : -1;
    }
    ...
    public PointF computeScrollVectorForPosition(int i) {
        ...
        if (layoutManager instanceof RecyclerView.q.b) {
            return ((RecyclerView.q.b) layoutManager).computeScrollVectorForPosition(i);
        }

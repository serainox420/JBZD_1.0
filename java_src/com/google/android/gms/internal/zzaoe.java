...
public class zzaoe extends zzaob<zzaot> {
    ...
    public static class zzb extends Api.zza<zzaoe, Api.ApiOptions.NoOptions> {
        ...
        /* renamed from: zzi */
        public zzaoe zza(Context context, Looper looper, com.google.android.gms.common.internal.zzg zzgVar, Api.ApiOptions.NoOptions noOptions, GoogleApiClient.ConnectionCallbacks connectionCallbacks, GoogleApiClient.OnConnectionFailedListener onConnectionFailedListener) {
            return new zzaoe(context, looper, zzgVar, connectionCallbacks, onConnectionFailedListener);
        }
    }
    ...
    public zzaoe(Context context, Looper looper, com.google.android.gms.common.internal.zzg zzgVar, GoogleApiClient.ConnectionCallbacks connectionCallbacks, GoogleApiClient.OnConnectionFailedListener onConnectionFailedListener) {

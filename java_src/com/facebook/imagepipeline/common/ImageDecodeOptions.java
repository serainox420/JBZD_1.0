...
public class ImageDecodeOptions {
    ...
    public int hashCode() {
        int i = 1;
        int i2 = 0;
        int i3 = ((this.decodeAllFrames ? 1 : 0) + (((this.useLastFrameForPreview ? 1 : 0) + (((this.decodePreviewFrame ? 1 : 0) + (this.minDecodeIntervalMs * 31)) * 31)) * 31)) * 31;
        if (!this.forceStaticImage) {
            i = 0;
        }
        int ordinal = (((i3 + i) * 31) + this.bitmapConfig.ordinal()) * 31;
        if (this.customImageDecoder != null) {
            i2 = this.customImageDecoder.hashCode();
        }
        return ordinal + i2;
    }

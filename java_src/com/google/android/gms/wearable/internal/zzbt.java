...
public interface zzbt extends IInterface {
    ...
    /* loaded from: classes2.dex */
    public static abstract class zza extends Binder implements zzbt {

        /* renamed from: com.google.android.gms.wearable.internal.zzbt$zza$zza  reason: collision with other inner class name */
        /* loaded from: classes2.dex */
        private static class C0492zza implements zzbt {
            ...
            public void zzE(int i, int i2) throws RemoteException {
        ...
        public static zzbt zzfA(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof zzbt)) ? new C0492zza(iBinder) : (zzbt) queryLocalInterface;
        }
    ...
    void zzE(int i, int i2) throws RemoteException;
}

...
public class zzxz extends UIController {
    ...
    private final View.OnClickListener zzatA = new View.OnClickListener() { // from class: com.google.android.gms.internal.zzxz.1
        @Override // android.view.View.OnClickListener
        public void onClick(View view) {
            RemoteMediaClient remoteMediaClient = zzxz.this.getRemoteMediaClient();

...
public interface zzaou extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzaou {
        ...
        /* loaded from: classes2.dex */
        private static class C0236zza implements zzaou {
        ...
        public static zzaou zzcy(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof zzaou)) ? new C0236zza(iBinder) : (zzaou) queryLocalInterface;
        }

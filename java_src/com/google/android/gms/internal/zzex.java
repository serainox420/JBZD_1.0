...
public interface zzex extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzex {
        ...
        /* loaded from: classes2.dex */
        private static class C0330zza implements zzex {
            private IBinder zzrk;

            C0330zza(IBinder iBinder) {
                this.zzrk = iBinder;
            }
        ...
        public static zzex zzt(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof zzex)) ? new C0330zza(iBinder) : (zzex) queryLocalInterface;
        }

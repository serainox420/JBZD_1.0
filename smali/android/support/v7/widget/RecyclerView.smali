...
# instance fields
.field mAccessibilityDelegate:Landroid/support/v7/widget/ah;

.field private final mAccessibilityManager:Landroid/view/accessibility/AccessibilityManager;

.field private mActiveOnItemTouchListener:Landroid/support/v7/widget/RecyclerView$k;
...
.field private mBottomGlow:Landroid/support/v4/widget/k;

.field private mChildDrawingOrderCallback:Landroid/support/v7/widget/RecyclerView$d;

.field mChildHelper:Landroid/support/v7/widget/s;
...
.field mGapWorker:Landroid/support/v7/widget/aa;
...
.field private mLeftGlow:Landroid/support/v4/widget/k;
...
.field private final mObserver:Landroid/support/v7/widget/RecyclerView$p;
...
.field private mOnFlingListener:Landroid/support/v7/widget/RecyclerView$j;
...
.field mPrefetchRegistry:Landroid/support/v7/widget/aa$a;

.field private mPreserveFocusAfterLayout:Z

.field final mRecycler:Landroid/support/v7/widget/RecyclerView$n;

.field mRecyclerListener:Landroid/support/v7/widget/RecyclerView$o;

.field private mRightGlow:Landroid/support/v4/widget/k;

.field private final mScrollConsumed:[I

.field private mScrollFactor:F

.field private mScrollListener:Landroid/support/v7/widget/RecyclerView$l;
...
.field private mScrollingChildHelper:Landroid/support/v4/view/w;

.field final mState:Landroid/support/v7/widget/RecyclerView$r;
...
.field private mTopGlow:Landroid/support/v4/widget/k;
...
.field final mViewFlinger:Landroid/support/v7/widget/RecyclerView$t;

.field private final mViewInfoProcessCallback:Landroid/support/v7/widget/az$b;

.field final mViewInfoStore:Landroid/support/v7/widget/az;
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    iput-object v0, p0, Landroid/support/v7/widget/RecyclerView;->mObserver:Landroid/support/v7/widget/RecyclerView$p;
    ...
    iput-object v0, p0, Landroid/support/v7/widget/RecyclerView;->mRecycler:Landroid/support/v7/widget/RecyclerView$n;
    ...
    iput-object v0, p0, Landroid/support/v7/widget/RecyclerView;->mViewInfoStore:Landroid/support/v7/widget/az;
    ...
    iput-object v0, p0, Landroid/support/v7/widget/RecyclerView;->mViewFlinger:Landroid/support/v7/widget/RecyclerView$t;
    ...
    :goto_0
    iput-object v0, p0, Landroid/support/v7/widget/RecyclerView;->mPrefetchRegistry:Landroid/support/v7/widget/aa$a;
    ...
    iput-object v0, p0, Landroid/support/v7/widget/RecyclerView;->mState:Landroid/support/v7/widget/RecyclerView$r;
    ...
    iput-object v0, p0, Landroid/support/v7/widget/RecyclerView;->mViewInfoProcessCallback:Landroid/support/v7/widget/az$b;
    ...
    invoke-virtual {p0, v0}, Landroid/support/v7/widget/RecyclerView;->setAccessibilityDelegateCompat(Landroid/support/v7/widget/ah;)V
...
.method private addAnimatingView(Landroid/support/v7/widget/RecyclerView$u;)V
    .locals 5
    ...
    .line 1271
    :goto_0
    iget-object v3, p0, Landroid/support/v7/widget/RecyclerView;->mRecycler:Landroid/support/v7/widget/RecyclerView$n;

    invoke-virtual {p0, v2}, Landroid/support/v7/widget/RecyclerView;->getChildViewHolder(Landroid/view/View;)Landroid/support/v7/widget/RecyclerView$u;
    ...
    .line 1274
    iget-object v0, p0, Landroid/support/v7/widget/RecyclerView;->mChildHelper:Landroid/support/v7/widget/s;
...
.method private animateChange(Landroid/support/v7/widget/RecyclerView$u;Landroid/support/v7/widget/RecyclerView$u;Landroid/support/v7/widget/RecyclerView$e$c;Landroid/support/v7/widget/RecyclerView$e$c;ZZ)V
    .locals 2
    ...
    .line 3823
    invoke-direct {p0, p1}, Landroid/support/v7/widget/RecyclerView;->addAnimatingView(Landroid/support/v7/widget/RecyclerView$u;)V
    ...
    .line 3827
    invoke-direct {p0, p2}, Landroid/support/v7/widget/RecyclerView;->addAnimatingView(Landroid/support/v7/widget/RecyclerView$u;)V
    ...
    .line 3832
    iget-object v0, p0, Landroid/support/v7/widget/RecyclerView;->mRecycler:Landroid/support/v7/widget/RecyclerView$n;
...
.method static clearNestedRecyclerViewIfNotNested(Landroid/support/v7/widget/RecyclerView$u;)V
    .locals 3
    ...
    .line 5176
    iget-object v0, p0, Landroid/support/v7/widget/RecyclerView$u;->mNestedRecyclerView:Ljava/lang/ref/WeakReference;
    ...
    .line 5179
    iget-object v2, p0, Landroid/support/v7/widget/RecyclerView$u;->itemView:Landroid/view/View;
    ...
    .line 5190
    :cond_3
    iput-object v1, p0, Landroid/support/v7/widget/RecyclerView$u;->mNestedRecyclerView:Ljava/lang/ref/WeakReference;
...
.method private dispatchLayoutStep1()V
    ...
    .line 3483
    iget-object v2, p0, Landroid/support/v7/widget/RecyclerView;->mState:Landroid/support/v7/widget/RecyclerView$r;
    ...
    .line 3486
    iget-object v2, p0, Landroid/support/v7/widget/RecyclerView;->mViewInfoStore:Landroid/support/v7/widget/az;

    invoke-virtual {v2}, Landroid/support/v7/widget/az;->a()V
    ...
    iget-object v3, p0, Landroid/support/v7/widget/RecyclerView;->mState:Landroid/support/v7/widget/RecyclerView$r;
    ...
    .line 3492
    iget-object v0, p0, Landroid/support/v7/widget/RecyclerView;->mState:Landroid/support/v7/widget/RecyclerView$r;
    ...
    .line 3500
    iget-object v3, p0, Landroid/support/v7/widget/RecyclerView;->mChildHelper:Landroid/support/v7/widget/s;

    invoke-virtual {v3, v0}, Landroid/support/v7/widget/s;->b(I)Landroid/view/View;

    move-result-object v3

    invoke-static {v3}, Landroid/support/v7/widget/RecyclerView;->getChildViewHolderInt(Landroid/view/View;)Landroid/support/v7/widget/RecyclerView$u;
    ...
    iget-object v5, p0, Landroid/support/v7/widget/RecyclerView;->mState:Landroid/support/v7/widget/RecyclerView$r;
    ...
    .line 3508
    iget-object v5, p0, Landroid/support/v7/widget/RecyclerView;->mViewInfoStore:Landroid/support/v7/widget/az;

    invoke-virtual {v5, v3, v4}, Landroid/support/v7/widget/az;->a(Landroid/support/v7/widget/RecyclerView$u;Landroid/support/v7/widget/RecyclerView$e$c;)V

    .line 3509
    iget-object v4, p0, Landroid/support/v7/widget/RecyclerView;->mState:Landroid/support/v7/widget/RecyclerView$r;
    ...
    .line 3511
    invoke-virtual {p0, v3}, Landroid/support/v7/widget/RecyclerView;->getChangedHolderKey(Landroid/support/v7/widget/RecyclerView$u;)J

    move-result-wide v4

    .line 3519
    iget-object v6, p0, Landroid/support/v7/widget/RecyclerView;->mViewInfoStore:Landroid/support/v7/widget/az;

    invoke-virtual {v6, v4, v5, v3}, Landroid/support/v7/widget/az;->a(JLandroid/support/v7/widget/RecyclerView$u;)V
    ...
    invoke-virtual {v2, v3, v4}, Landroid/support/v7/widget/RecyclerView$h;->onLayoutChildren(Landroid/support/v7/widget/RecyclerView$n;Landroid/support/v7/widget/RecyclerView$r;)V
    ...
    .line 3537
    :goto_3
    iget-object v2, p0, Landroid/support/v7/widget/RecyclerView;->mChildHelper:Landroid/support/v7/widget/s;
    ...
    invoke-virtual {v2, v3}, Landroid/support/v7/widget/az;->d(Landroid/support/v7/widget/RecyclerView$u;)Z
    ...
    iget-object v6, p0, Landroid/support/v7/widget/RecyclerView;->mState:Landroid/support/v7/widget/RecyclerView$r;
    ...
    .line 3553
    invoke-virtual {p0, v3, v2}, Landroid/support/v7/widget/RecyclerView;->recordAnimationInfoIfBouncedHiddenView(Landroid/support/v7/widget/RecyclerView$u;Landroid/support/v7/widget/RecyclerView$e$c;)V

    goto :goto_4

    .line 3555
    :cond_7
    iget-object v4, p0, Landroid/support/v7/widget/RecyclerView;->mViewInfoStore:Landroid/support/v7/widget/az;

    invoke-virtual {v4, v3, v2}, Landroid/support/v7/widget/az;->b(Landroid/support/v7/widget/RecyclerView$u;Landroid/support/v7/widget/RecyclerView$e$c;)V
...
.method private dispatchLayoutStep2()V
    ...
    iget-object v2, p0, Landroid/support/v7/widget/RecyclerView;->mRecycler:Landroid/support/v7/widget/RecyclerView$n;

    iget-object v3, p0, Landroid/support/v7/widget/RecyclerView;->mState:Landroid/support/v7/widget/RecyclerView$r;

    invoke-virtual {v0, v2, v3}, Landroid/support/v7/widget/RecyclerView$h;->onLayoutChildren(Landroid/support/v7/widget/RecyclerView$n;Landroid/support/v7/widget/RecyclerView$r;)V
...
.method private dispatchLayoutStep3()V
    ...
    .line 3613
    :cond_0
    invoke-virtual {p0, v2}, Landroid/support/v7/widget/RecyclerView;->getChangedHolderKey(Landroid/support/v7/widget/RecyclerView$u;)J
    ...
    iget-object v1, p0, Landroid/support/v7/widget/RecyclerView;->mState:Landroid/support/v7/widget/RecyclerView$r;
    ...
    .line 3616
    iget-object v1, p0, Landroid/support/v7/widget/RecyclerView;->mViewInfoStore:Landroid/support/v7/widget/az;

    invoke-virtual {v1, v8, v9}, Landroid/support/v7/widget/az;->a(J)Landroid/support/v7/widget/RecyclerView$u;
    ...
    .line 3628
    iget-object v3, p0, Landroid/support/v7/widget/RecyclerView;->mViewInfoStore:Landroid/support/v7/widget/az;

    invoke-virtual {v3, v1}, Landroid/support/v7/widget/az;->a(Landroid/support/v7/widget/RecyclerView$u;)Z
    ...
    invoke-virtual {v3, v2}, Landroid/support/v7/widget/az;->a(Landroid/support/v7/widget/RecyclerView$u;)Z
    ...
    invoke-virtual {v1, v2, v0}, Landroid/support/v7/widget/az;->c(Landroid/support/v7/widget/RecyclerView$u;Landroid/support/v7/widget/RecyclerView$e$c;)V
    ...
    invoke-virtual {v3, v1}, Landroid/support/v7/widget/az;->b(Landroid/support/v7/widget/RecyclerView$u;)Landroid/support/v7/widget/RecyclerView$e$c;
    ...
    invoke-virtual {v4, v2, v0}, Landroid/support/v7/widget/az;->c(Landroid/support/v7/widget/RecyclerView$u;Landroid/support/v7/widget/RecyclerView$e$c;)V

    .line 3639
    iget-object v0, p0, Landroid/support/v7/widget/RecyclerView;->mViewInfoStore:Landroid/support/v7/widget/az;

    invoke-virtual {v0, v2}, Landroid/support/v7/widget/az;->c(Landroid/support/v7/widget/RecyclerView$u;)Landroid/support/v7/widget/RecyclerView$e$c;
    ...
    .line 3641
    invoke-direct {p0, v8, v9, v2, v1}, Landroid/support/v7/widget/RecyclerView;->handleMissingPreInfoForChangeError(JLandroid/support/v7/widget/RecyclerView$u;Landroid/support/v7/widget/RecyclerView$u;)V
    ...
    .line 3643
    invoke-direct/range {v0 .. v6}, Landroid/support/v7/widget/RecyclerView;->animateChange(Landroid/support/v7/widget/RecyclerView$u;Landroid/support/v7/widget/RecyclerView$u;Landroid/support/v7/widget/RecyclerView$e$c;Landroid/support/v7/widget/RecyclerView$e$c;ZZ)V
    ...
    iget-object v1, p0, Landroid/support/v7/widget/RecyclerView;->mViewInfoProcessCallback:Landroid/support/v7/widget/az$b;

    invoke-virtual {v0, v1}, Landroid/support/v7/widget/az;->a(Landroid/support/v7/widget/az$b;)V

    .line 3656
    :cond_5
    iget-object v0, p0, Landroid/support/v7/widget/RecyclerView;->mLayout:Landroid/support/v7/widget/RecyclerView$h;

    iget-object v1, p0, Landroid/support/v7/widget/RecyclerView;->mRecycler:Landroid/support/v7/widget/RecyclerView$n;

    invoke-virtual {v0, v1}, Landroid/support/v7/widget/RecyclerView$h;->removeAndRecycleScrapInt(Landroid/support/v7/widget/RecyclerView$n;)V
    ...
    invoke-virtual {v0, v1}, Landroid/support/v7/widget/RecyclerView$h;->onLayoutCompleted(Landroid/support/v7/widget/RecyclerView$r;)V
...
.method private dispatchOnItemTouch(Landroid/view/MotionEvent;)Z
    ...
    .line 2638
    iget-object v3, p0, Landroid/support/v7/widget/RecyclerView;->mActiveOnItemTouchListener:Landroid/support/v7/widget/RecyclerView$k;
    ...
    .line 2641
    iput-object v4, p0, Landroid/support/v7/widget/RecyclerView;->mActiveOnItemTouchListener:Landroid/support/v7/widget/RecyclerView$k;
    ...
    .line 2659
    iput-object v0, p0, Landroid/support/v7/widget/RecyclerView;->mActiveOnItemTouchListener:Landroid/support/v7/widget/RecyclerView$k;
    ...
    .line 2643
    :cond_1
    iget-object v2, p0, Landroid/support/v7/widget/RecyclerView;->mActiveOnItemTouchListener:Landroid/support/v7/widget/RecyclerView$k;
...
.method private findMinMaxChildLayoutPositions([I)V
    ...
    .line 3756
    iget-object v1, p0, Landroid/support/v7/widget/RecyclerView;->mChildHelper:Landroid/support/v7/widget/s;
...
.method private findNextViewToFocus()Landroid/view/View;
    ...
    .line 3368
    invoke-virtual {p0, v2}, Landroid/support/v7/widget/RecyclerView;->findViewHolderForAdapterPosition(I)Landroid/support/v7/widget/RecyclerView$u;
    ...
    .line 3378
    invoke-virtual {p0, v0}, Landroid/support/v7/widget/RecyclerView;->findViewHolderForAdapterPosition(I)Landroid/support/v7/widget/RecyclerView$u;
    ...
    .line 3372
    :cond_2
    iget-object v5, v4, Landroid/support/v7/widget/RecyclerView$u;->itemView:Landroid/view/View;
...
.method static getChildViewHolderInt(Landroid/view/View;)Landroid/support/v7/widget/RecyclerView$u;
    .locals 1
...
.method private getScrollingChildHelper()Landroid/support/v4/view/w;
    ...
    .prologue
    .line 12568
    iget-object v0, p0, Landroid/support/v7/widget/RecyclerView;->mScrollingChildHelper:Landroid/support/v4/view/w;
    ...
    iput-object v0, p0, Landroid/support/v7/widget/RecyclerView;->mScrollingChildHelper:Landroid/support/v4/view/w;
...
.method private handleMissingPreInfoForChangeError(JLandroid/support/v7/widget/RecyclerView$u;Landroid/support/v7/widget/RecyclerView$u;)V
    .locals 7
...
.method private initChildrenHelper()V
    ...
    iput-object v0, p0, Landroid/support/v7/widget/RecyclerView;->mChildHelper:Landroid/support/v7/widget/s;
...
.method private pullGlows(FFFF)V
    ...
    .line 2108
    iget-object v2, p0, Landroid/support/v7/widget/RecyclerView;->mLeftGlow:Landroid/support/v4/widget/k;
    ...
    .line 2120
    iget-object v2, p0, Landroid/support/v7/widget/RecyclerView;->mTopGlow:Landroid/support/v4/widget/k;
    ...
    .line 2113
    iget-object v2, p0, Landroid/support/v7/widget/RecyclerView;->mRightGlow:Landroid/support/v4/widget/k;
    ...
    .line 2125
    iget-object v2, p0, Landroid/support/v7/widget/RecyclerView;->mBottomGlow:Landroid/support/v4/widget/k;
...
.method private recoverFocusFromState()V
    ...
    invoke-virtual {p0, v2, v3}, Landroid/support/v7/widget/RecyclerView;->findViewHolderForItemId(J)Landroid/support/v7/widget/RecyclerView$u;
...
.method private releaseGlows()V
    ...
    .line 2137
    iget-object v1, p0, Landroid/support/v7/widget/RecyclerView;->mLeftGlow:Landroid/support/v4/widget/k;

    if-eqz v1, :cond_0

    iget-object v0, p0, Landroid/support/v7/widget/RecyclerView;->mLeftGlow:Landroid/support/v4/widget/k;
    ...
    .line 2138
    :cond_0
    iget-object v1, p0, Landroid/support/v7/widget/RecyclerView;->mTopGlow:Landroid/support/v4/widget/k;
    ...
    .line 2139
    :cond_1
    iget-object v1, p0, Landroid/support/v7/widget/RecyclerView;->mRightGlow:Landroid/support/v4/widget/k;
    ...
    .line 2140
    :cond_2
    iget-object v1, p0, Landroid/support/v7/widget/RecyclerView;->mBottomGlow:Landroid/support/v4/widget/k;
...
.method private saveFocusInfo()V
    ...
    .line 3332
    :cond_0
    invoke-virtual {p0, v1}, Landroid/support/v7/widget/RecyclerView;->findContainingViewHolder(Landroid/view/View;)Landroid/support/v7/widget/RecyclerView$u;
    ...
    .line 3341
    :cond_3
    invoke-virtual {v2}, Landroid/support/v7/widget/RecyclerView$u;->isRemoved()Z

    move-result v0

    if-eqz v0, :cond_4

    iget v0, v2, Landroid/support/v7/widget/RecyclerView$u;->mOldPosition:I

    goto :goto_4

    .line 3342
    :cond_4
    invoke-virtual {v2}, Landroid/support/v7/widget/RecyclerView$u;->getAdapterPosition()I
...
.method private setAdapterInternal(Landroid/support/v7/widget/RecyclerView$a;ZZ)V
    ...
    iget-object v1, p0, Landroid/support/v7/widget/RecyclerView;->mObserver:Landroid/support/v7/widget/RecyclerView$p;
...
.method private stopScrollersInternal()V
    ...
    .prologue
    .line 2076
    iget-object v0, p0, Landroid/support/v7/widget/RecyclerView;->mViewFlinger:Landroid/support/v7/widget/RecyclerView$t;
...
.method absorbGlows(II)V
    ...
    .line 2176
    iget-object v0, p0, Landroid/support/v7/widget/RecyclerView;->mTopGlow:Landroid/support/v4/widget/k;
    ...
    .line 2171
    iget-object v0, p0, Landroid/support/v7/widget/RecyclerView;->mRightGlow:Landroid/support/v4/widget/k;
    ...
    .line 2179
    iget-object v0, p0, Landroid/support/v7/widget/RecyclerView;->mBottomGlow:Landroid/support/v4/widget/k;
...
.method public addOnChildAttachStateChangeListener(Landroid/support/v7/widget/RecyclerView$i;)V
    .locals 1
...
.method public addOnScrollListener(Landroid/support/v7/widget/RecyclerView$l;)V
    .locals 1
...
.method animateAppearance(Landroid/support/v7/widget/RecyclerView$u;Landroid/support/v7/widget/RecyclerView$e$c;Landroid/support/v7/widget/RecyclerView$e$c;)V
    .locals 1
...
.method animateDisappearance(Landroid/support/v7/widget/RecyclerView$u;Landroid/support/v7/widget/RecyclerView$e$c;Landroid/support/v7/widget/RecyclerView$e$c;)V
    .locals 1
...
.method canReuseUpdatedViewHolder(Landroid/support/v7/widget/RecyclerView$u;)Z
    .locals 2
...
.method protected checkLayoutParams(Landroid/view/ViewGroup$LayoutParams;)Z
    ...
    invoke-virtual {v0, p1}, Landroid/support/v7/widget/RecyclerView$h;->checkLayoutParams(Landroid/support/v7/widget/RecyclerView$LayoutParams;)Z
...
.method public computeHorizontalScrollExtent()I
    ...
    invoke-virtual {v0, v1}, Landroid/support/v7/widget/RecyclerView$h;->computeHorizontalScrollExtent(Landroid/support/v7/widget/RecyclerView$r;)I
...
.method public computeHorizontalScrollOffset()I
    ...
    invoke-virtual {v0, v1}, Landroid/support/v7/widget/RecyclerView$h;->computeHorizontalScrollOffset(Landroid/support/v7/widget/RecyclerView$r;)I
...
.method public computeHorizontalScrollRange()I
    ...
    invoke-virtual {v0, v1}, Landroid/support/v7/widget/RecyclerView$h;->computeHorizontalScrollRange(Landroid/support/v7/widget/RecyclerView$r;)I
...
.method public computeVerticalScrollExtent()I
    ...
    invoke-virtual {v0, v1}, Landroid/support/v7/widget/RecyclerView$h;->computeVerticalScrollExtent(Landroid/support/v7/widget/RecyclerView$r;)I
...
.method public computeVerticalScrollOffset()I
    ...
    invoke-virtual {v0, v1}, Landroid/support/v7/widget/RecyclerView$h;->computeVerticalScrollOffset(Landroid/support/v7/widget/RecyclerView$r;)I
...
.method public computeVerticalScrollRange()I
    ...
    invoke-virtual {v0, v1}, Landroid/support/v7/widget/RecyclerView$h;->computeVerticalScrollRange(Landroid/support/v7/widget/RecyclerView$r;)I
...
.method dispatchOnScrollStateChanged(I)V
    ...
    .line 4650
    iget-object v0, p0, Landroid/support/v7/widget/RecyclerView;->mScrollListener:Landroid/support/v7/widget/RecyclerView$l;
    ...
    invoke-virtual {v0, p0, p1}, Landroid/support/v7/widget/RecyclerView$l;->onScrollStateChanged(Landroid/support/v7/widget/RecyclerView;I)V
...
.method dispatchOnScrolled(II)V
    ...
    invoke-virtual {v0, p0, p1, p2}, Landroid/support/v7/widget/RecyclerView$l;->onScrolled(Landroid/support/v7/widget/RecyclerView;II)V
...
.method dispatchPendingImportantForAccessibilityChanges()V
    ...
    .line 10701
    :cond_1
    iget v2, v0, Landroid/support/v7/widget/RecyclerView$u;->mPendingAccessibilityState:I
    ...
    .line 10705
    iput v4, v0, Landroid/support/v7/widget/RecyclerView$u;->mPendingAccessibilityState:I
...
.method public draw(Landroid/graphics/Canvas;)V
    ...
    .line 3886
    :goto_3
    iget-object v3, p0, Landroid/support/v7/widget/RecyclerView;->mTopGlow:Landroid/support/v4/widget/k;
    ...
    .line 3894
    :cond_2
    iget-object v3, p0, Landroid/support/v7/widget/RecyclerView;->mRightGlow:Landroid/support/v4/widget/k;
    ...
    .line 3903
    :cond_3
    iget-object v3, p0, Landroid/support/v7/widget/RecyclerView;->mBottomGlow:Landroid/support/v4/widget/k;
    ...
    .line 3911
    :goto_7
    iget-object v4, p0, Landroid/support/v7/widget/RecyclerView;->mBottomGlow:Landroid/support/v4/widget/k;
...
.method ensureBottomGlow()V
    ...
    iput-object v0, p0, Landroid/support/v7/widget/RecyclerView;->mBottomGlow:Landroid/support/v4/widget/k;
...
.method ensureLeftGlow()V
    ...
    iput-object v0, p0, Landroid/support/v7/widget/RecyclerView;->mLeftGlow:Landroid/support/v4/widget/k;
...
.method ensureRightGlow()V
    ...
    iput-object v0, p0, Landroid/support/v7/widget/RecyclerView;->mRightGlow:Landroid/support/v4/widget/k;
...
.method ensureTopGlow()V
    ...
    iput-object v0, p0, Landroid/support/v7/widget/RecyclerView;->mTopGlow:Landroid/support/v4/widget/k;
...
.method public findContainingViewHolder(Landroid/view/View;)Landroid/support/v7/widget/RecyclerView$u;
    .locals 1
    ...
    :cond_0
    invoke-virtual {p0, v0}, Landroid/support/v7/widget/RecyclerView;->getChildViewHolder(Landroid/view/View;)Landroid/support/v7/widget/RecyclerView$u;
...
.method public findViewHolderForAdapterPosition(I)Landroid/support/v7/widget/RecyclerView$u;
    .locals 5
    ...
    invoke-virtual {p0, v0}, Landroid/support/v7/widget/RecyclerView;->getAdapterPositionFor(Landroid/support/v7/widget/RecyclerView$u;)I
...
.method public findViewHolderForItemId(J)Landroid/support/v7/widget/RecyclerView$u;
    .locals 7
...
.method public findViewHolderForLayoutPosition(I)Landroid/support/v7/widget/RecyclerView$u;
    .locals 1
    ...
    invoke-virtual {p0, p1, v0}, Landroid/support/v7/widget/RecyclerView;->findViewHolderForPosition(IZ)Landroid/support/v7/widget/RecyclerView$u;
...
.method public findViewHolderForPosition(I)Landroid/support/v7/widget/RecyclerView$u;
    .locals 1
...
.method findViewHolderForPosition(IZ)Landroid/support/v7/widget/RecyclerView$u;
    .locals 5
    ...
    .line 4400
    iget v4, v1, Landroid/support/v7/widget/RecyclerView$u;->mPosition:I
...
.method public fling(II)Z
    ...
    .line 2049
    iget-object v3, p0, Landroid/support/v7/widget/RecyclerView;->mOnFlingListener:Landroid/support/v7/widget/RecyclerView$j;
    ...
    .line 2056
    iget-object v3, p0, Landroid/support/v7/widget/RecyclerView;->mViewFlinger:Landroid/support/v7/widget/RecyclerView$t;
...
.method public focusSearch(Landroid/view/View;I)Landroid/view/View;
    ...
    invoke-virtual {v0, p1, p2, v1, v3}, Landroid/support/v7/widget/RecyclerView$h;->onFocusSearchFailed(Landroid/view/View;ILandroid/support/v7/widget/RecyclerView$n;Landroid/support/v7/widget/RecyclerView$r;)Landroid/view/View;
...
.method protected generateDefaultLayoutParams()Landroid/view/ViewGroup$LayoutParams;
    ...
    invoke-virtual {v0}, Landroid/support/v7/widget/RecyclerView$h;->generateDefaultLayoutParams()Landroid/support/v7/widget/RecyclerView$LayoutParams;
...
.method public generateLayoutParams(Landroid/util/AttributeSet;)Landroid/view/ViewGroup$LayoutParams;
    ...
    invoke-virtual {v0, v1, p1}, Landroid/support/v7/widget/RecyclerView$h;->generateLayoutParams(Landroid/content/Context;Landroid/util/AttributeSet;)Landroid/support/v7/widget/RecyclerView$LayoutParams;
...
.method protected generateLayoutParams(Landroid/view/ViewGroup$LayoutParams;)Landroid/view/ViewGroup$LayoutParams;
    ...
    invoke-virtual {v0, p1}, Landroid/support/v7/widget/RecyclerView$h;->generateLayoutParams(Landroid/view/ViewGroup$LayoutParams;)Landroid/support/v7/widget/RecyclerView$LayoutParams;
...
.method getAdapterPositionFor(Landroid/support/v7/widget/RecyclerView$u;)I
    .locals 2
...
.method getChangedHolderKey(Landroid/support/v7/widget/RecyclerView$u;)J
    .locals 2
...
.method public getCompatAccessibilityDelegate()Landroid/support/v7/widget/ah;
    .locals 1

    .prologue
    .line 620
    iget-object v0, p0, Landroid/support/v7/widget/RecyclerView;->mAccessibilityDelegate:Landroid/support/v7/widget/ah;
...
.method getItemDecorInsetsForChild(Landroid/view/View;)Landroid/graphics/Rect;
    ...
    iget-object v7, p0, Landroid/support/v7/widget/RecyclerView;->mState:Landroid/support/v7/widget/RecyclerView$r;
...
.method public getOnFlingListener()Landroid/support/v7/widget/RecyclerView$j;
    ...
    .prologue
    .line 1213
    iget-object v0, p0, Landroid/support/v7/widget/RecyclerView;->mOnFlingListener:Landroid/support/v7/widget/RecyclerView$j;
...
.method offsetPositionRecordsForMove(II)V
    ...
    .line 4018
    iget-object v7, p0, Landroid/support/v7/widget/RecyclerView;->mChildHelper:Landroid/support/v7/widget/s;

    invoke-virtual {v7, v4}, Landroid/support/v7/widget/s;->d(I)Landroid/view/View;

    move-result-object v7

    invoke-static {v7}, Landroid/support/v7/widget/RecyclerView;->getChildViewHolderInt(Landroid/view/View;)Landroid/support/v7/widget/RecyclerView$u;
...
.method protected onAttachedToWindow()V
    ...
    iput-object v0, p0, Landroid/support/v7/widget/RecyclerView;->mGapWorker:Landroid/support/v7/widget/aa;

    .line 2497
    iget-object v0, p0, Landroid/support/v7/widget/RecyclerView;->mGapWorker:Landroid/support/v7/widget/aa;
    ...
    .line 2502
    invoke-static {p0}, Landroid/support/v4/view/ai;->J(Landroid/view/View;)Landroid/view/Display;
    ...
    .line 2510
    :goto_1
    iget-object v1, p0, Landroid/support/v7/widget/RecyclerView;->mGapWorker:Landroid/support/v7/widget/aa;
...
.method protected onDetachedFromWindow()V
    ...
    invoke-virtual {v0, p0, v1}, Landroid/support/v7/widget/RecyclerView$h;->dispatchDetachedFromWindow(Landroid/support/v7/widget/RecyclerView;Landroid/support/v7/widget/RecyclerView$n;)V
...
.method protected onMeasure(II)V
    ...
    invoke-virtual {v2, v3, v4, p1, p2}, Landroid/support/v7/widget/RecyclerView$h;->onMeasure(Landroid/support/v7/widget/RecyclerView$n;Landroid/support/v7/widget/RecyclerView$r;II)V
    ...
    invoke-virtual {v0, v1, v2, p1, p2}, Landroid/support/v7/widget/RecyclerView$h;->onMeasure(Landroid/support/v7/widget/RecyclerView$n;Landroid/support/v7/widget/RecyclerView$r;II)V
    ...
    invoke-virtual {v1, v2, v3, p1, p2}, Landroid/support/v7/widget/RecyclerView$h;->onMeasure(Landroid/support/v7/widget/RecyclerView$n;Landroid/support/v7/widget/RecyclerView$r;II)V
...
.method public onTouchEvent(Landroid/view/MotionEvent;)Z
    ...
    .line 2889
    :cond_c
    iget-object v2, p0, Landroid/support/v7/widget/RecyclerView;->mGapWorker:Landroid/support/v7/widget/aa;
    ...
    invoke-virtual {v2, p0, v1, v0}, Landroid/support/v7/widget/aa;->a(Landroid/support/v7/widget/RecyclerView;II)V
...
.method recordAnimationInfoIfBouncedHiddenView(Landroid/support/v7/widget/RecyclerView$u;Landroid/support/v7/widget/RecyclerView$e$c;)V
    .locals 3
    ...
    .line 3740
    invoke-virtual {p0, p1}, Landroid/support/v7/widget/RecyclerView;->getChangedHolderKey(Landroid/support/v7/widget/RecyclerView$u;)J
    ...
    invoke-virtual {v2, v0, v1, p1}, Landroid/support/v7/widget/az;->a(JLandroid/support/v7/widget/RecyclerView$u;)V

    .line 3743
    :cond_0
    iget-object v0, p0, Landroid/support/v7/widget/RecyclerView;->mViewInfoStore:Landroid/support/v7/widget/az;

    invoke-virtual {v0, p1, p2}, Landroid/support/v7/widget/az;->a(Landroid/support/v7/widget/RecyclerView$u;Landroid/support/v7/widget/RecyclerView$e$c;)V
...
.method removeAndRecycleViews()V
    ...
    invoke-virtual {v0, v1}, Landroid/support/v7/widget/RecyclerView$h;->removeAndRecycleAllViews(Landroid/support/v7/widget/RecyclerView$n;)V
...
.method public removeOnChildAttachStateChangeListener(Landroid/support/v7/widget/RecyclerView$i;)V
    .locals 1
...
.method public removeOnItemTouchListener(Landroid/support/v7/widget/RecyclerView$k;)V
    ...
    .line 2614
    iget-object v0, p0, Landroid/support/v7/widget/RecyclerView;->mActiveOnItemTouchListener:Landroid/support/v7/widget/RecyclerView$k;
...
.method public removeOnScrollListener(Landroid/support/v7/widget/RecyclerView$l;)V
    .locals 1
...
.method public requestChildFocus(Landroid/view/View;Landroid/view/View;)V
    ...
    invoke-virtual {v0, p0, v1, p1, p2}, Landroid/support/v7/widget/RecyclerView$h;->onRequestChildFocus(Landroid/support/v7/widget/RecyclerView;Landroid/support/v7/widget/RecyclerView$r;Landroid/view/View;Landroid/view/View;)Z
...
.method scrollByInternal(IILandroid/view/MotionEvent;)Z
    ...
    invoke-virtual {v0, p1, v1, v2}, Landroid/support/v7/widget/RecyclerView$h;->scrollHorizontallyBy(ILandroid/support/v7/widget/RecyclerView$n;Landroid/support/v7/widget/RecyclerView$r;)I
    ...
    invoke-virtual {v0, p2, v1, v4}, Landroid/support/v7/widget/RecyclerView$h;->scrollVerticallyBy(ILandroid/support/v7/widget/RecyclerView$n;Landroid/support/v7/widget/RecyclerView$r;)I
...
.method public setAccessibilityDelegateCompat(Landroid/support/v7/widget/ah;)V
    .locals 1

    .prologue
    .line 629
    iput-object p1, p0, Landroid/support/v7/widget/RecyclerView;->mAccessibilityDelegate:Landroid/support/v7/widget/ah;
...
.method setChildImportantForAccessibilityInternal(Landroid/support/v7/widget/RecyclerView$u;I)Z
    .locals 1
    ...
    .line 10687
    iput p2, p1, Landroid/support/v7/widget/RecyclerView$u;->mPendingAccessibilityState:I
...
.method public setOnFlingListener(Landroid/support/v7/widget/RecyclerView$j;)V
    ...
    .prologue
    .line 1203
    iput-object p1, p0, Landroid/support/v7/widget/RecyclerView;->mOnFlingListener:Landroid/support/v7/widget/RecyclerView$j;
...
.method public setOnScrollListener(Landroid/support/v7/widget/RecyclerView$l;)V
    ...
    .prologue
    .line 1488
    iput-object p1, p0, Landroid/support/v7/widget/RecyclerView;->mScrollListener:Landroid/support/v7/widget/RecyclerView$l;
...
.method public setRecyclerListener(Landroid/support/v7/widget/RecyclerView$o;)V
    ...
    .prologue
    .line 1081
    iput-object p1, p0, Landroid/support/v7/widget/RecyclerView;->mRecyclerListener:Landroid/support/v7/widget/RecyclerView$o;
...
.method public smoothScrollBy(IILandroid/view/animation/Interpolator;)V
    ...
    .line 2004
    :cond_3
    iget-object v1, p0, Landroid/support/v7/widget/RecyclerView;->mViewFlinger:Landroid/support/v7/widget/RecyclerView$t;
...
.method public smoothScrollToPosition(I)V
    ...
    invoke-virtual {v0, p0, v1, p1}, Landroid/support/v7/widget/RecyclerView$h;->smoothScrollToPosition(Landroid/support/v7/widget/RecyclerView;Landroid/support/v7/widget/RecyclerView$r;I)V

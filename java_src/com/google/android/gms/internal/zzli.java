...
public interface zzli extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzli {
        ...
        /* loaded from: classes2.dex */
        private static class C0368zza implements zzli {
            private IBinder zzrk;

            C0368zza(IBinder iBinder) {
                this.zzrk = iBinder;
            }
            ...
            @Override // com.google.android.gms.internal.zzli
            public void zza(zzlh zzlhVar) throws RemoteException {
                Parcel obtain = Parcel.obtain();
                Parcel obtain2 = Parcel.obtain();
                try {
                    obtain.writeInterfaceToken("com.google.android.gms.ads.internal.purchase.client.IPlayStorePurchaseListener");
                    obtain.writeStrongBinder(zzlhVar != null ? zzlhVar.asBinder() : null);
        ...
        public static zzli zzab(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof zzli)) ? new C0368zza(iBinder) : (zzli) queryLocalInterface;
        }

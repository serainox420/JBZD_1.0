...
public interface zzv extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzv {
        ...
        /* loaded from: classes2.dex */
        private static class C0458zza implements zzv {
            private IBinder zzrk;

            C0458zza(IBinder iBinder) {
                this.zzrk = iBinder;
            }
        ...
        public static zzv zzdQ(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof zzv)) ? new C0458zza(iBinder) : (zzv) queryLocalInterface;
        }

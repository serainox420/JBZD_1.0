...
public interface zzaol extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzaol {
        ...
        /* loaded from: classes2.dex */
        private static class C0227zza implements zzaol {
        ...
        public static zzaol zzcp(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof zzaol)) ? new C0227zza(iBinder) : (zzaol) queryLocalInterface;
        }

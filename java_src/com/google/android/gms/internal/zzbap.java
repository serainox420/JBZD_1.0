...
public interface zzbap extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzbap {
        ...
        /* loaded from: classes2.dex */
        private static class C0287zza implements zzbap {
            private IBinder zzrk;

            C0287zza(IBinder iBinder) {
                this.zzrk = iBinder;
            }
            ...
            public void zza(ConnectionResult connectionResult, zzbak zzbakVar) throws RemoteException {
                ...
                try {
                    ...
                    if (zzbakVar != null) {
                        obtain.writeInt(1);
                        zzbakVar.writeToParcel(obtain, 0);
                    } else {
                        obtain.writeInt(0);
                    }
            ...
            @Override // com.google.android.gms.internal.zzbap
            public void zzb(zzbaw zzbawVar) throws RemoteException {
                Parcel obtain = Parcel.obtain();
                Parcel obtain2 = Parcel.obtain();
                try {
                    obtain.writeInterfaceToken("com.google.android.gms.signin.internal.ISignInCallbacks");
                    if (zzbawVar != null) {
                        obtain.writeInt(1);
                        zzbawVar.writeToParcel(obtain, 0);
                    } else {
                        obtain.writeInt(0);
                    }
        ...
        public static zzbap zzfe(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof zzbap)) ? new C0287zza(iBinder) : (zzbap) queryLocalInterface;
        }
    ...
    void zza(ConnectionResult connectionResult, zzbak zzbakVar) throws RemoteException;

    void zza(Status status, GoogleSignInAccount googleSignInAccount) throws RemoteException;

    void zzb(zzbaw zzbawVar) throws RemoteException;

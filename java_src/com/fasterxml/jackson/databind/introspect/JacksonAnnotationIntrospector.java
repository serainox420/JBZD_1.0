...
public class JacksonAnnotationIntrospector extends AnnotationIntrospector implements Serializable {
    ...
    public VisibilityChecker<?> findAutoDetectVisibility(AnnotatedClass annotatedClass, VisibilityChecker<?> visibilityChecker) {
        ...
        return jsonAutoDetect == null ? visibilityChecker : visibilityChecker.mo356with(jsonAutoDetect);
    }
    ...
    public TypeResolverBuilder<?> findPropertyContentTypeResolver(MapperConfig<?> mapperConfig, AnnotatedMember annotatedMember, JavaType javaType) {
        if (javaType.mo463getContentType() == null) {
    ...
    public boolean hasCreatorAnnotation(Annotated annotated) {
        ...
        } else if (this._cfgConstructorPropertiesImpliesCreator && (annotated instanceof AnnotatedConstructor) && _java7Helper != null && (hasCreatorAnnotation = _java7Helper.hasCreatorAnnotation(annotated)) != null) {

...
public interface zzhj extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzhj {
        ...
        /* loaded from: classes2.dex */
        private static class C0341zza implements zzhj {
            private IBinder zzrk;

            C0341zza(IBinder iBinder) {
                this.zzrk = iBinder;
            }
        ...
        public static zzhj zzE(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof zzhj)) ? new C0341zza(iBinder) : (zzhj) queryLocalInterface;
        }

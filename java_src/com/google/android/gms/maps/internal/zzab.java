...
public interface zzab extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzab {
        ...
        /* loaded from: classes2.dex */
        private static class C0432zza implements zzab {
            private IBinder zzrk;

            C0432zza(IBinder iBinder) {
                this.zzrk = iBinder;
            }
        ...
        public static zzab zzdW(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof zzab)) ? new C0432zza(iBinder) : (zzab) queryLocalInterface;
        }

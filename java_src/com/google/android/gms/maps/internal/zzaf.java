...
public interface zzaf extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzaf {
        ...
        /* loaded from: classes2.dex */
        private static class C0436zza implements zzaf {
            private IBinder zzrk;

            C0436zza(IBinder iBinder) {
                this.zzrk = iBinder;
            }
        ...
        public static zzaf zzea(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof zzaf)) ? new C0436zza(iBinder) : (zzaf) queryLocalInterface;
        }

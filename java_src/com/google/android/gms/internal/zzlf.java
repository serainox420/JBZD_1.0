...
public interface zzlf extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzlf {
        ...
        /* loaded from: classes2.dex */
        private static class C0365zza implements zzlf {
            private IBinder zzrk;

            C0365zza(IBinder iBinder) {
                this.zzrk = iBinder;
            }
        ...
        public static zzlf zzY(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof zzlf)) ? new C0365zza(iBinder) : (zzlf) queryLocalInterface;
        }

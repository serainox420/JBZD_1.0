...
public class zzaoi extends zzaob<zzaox> {
    ...
    public static class zzb extends Api.zza<zzaoi, Api.ApiOptions.NoOptions> {
        ...
        /* renamed from: zzm */
        public zzaoi zza(Context context, Looper looper, com.google.android.gms.common.internal.zzg zzgVar, Api.ApiOptions.NoOptions noOptions, GoogleApiClient.ConnectionCallbacks connectionCallbacks, GoogleApiClient.OnConnectionFailedListener onConnectionFailedListener) {
            return new zzaoi(context, looper, zzgVar, connectionCallbacks, onConnectionFailedListener);
        }
    }
    ...
    public zzaoi(Context context, Looper looper, com.google.android.gms.common.internal.zzg zzgVar, GoogleApiClient.ConnectionCallbacks connectionCallbacks, GoogleApiClient.OnConnectionFailedListener onConnectionFailedListener) {
        super(context, looper, 56, connectionCallbacks, onConnectionFailedListener, zzgVar);
    }

...
public interface zzi extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzi {
        ...
        /* loaded from: classes2.dex */
        private static class C0473zza implements zzi {
            private IBinder zzrk;

            C0473zza(IBinder iBinder) {
                this.zzrk = iBinder;
            }
        ...
        public static zzi zzer(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof zzi)) ? new C0473zza(iBinder) : (zzi) queryLocalInterface;
        }

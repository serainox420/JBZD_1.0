...
public class BeanDeserializer extends BeanDeserializerBase implements Serializable {
    ...
    public /* bridge */ /* synthetic */ BeanDeserializerBase mo257withIgnorableProperties(Set set) {
        return mo257withIgnorableProperties((Set<String>) set);
    }
    ...
    public BeanDeserializer mo258withObjectIdReader(ObjectIdReader objectIdReader) {
        return new BeanDeserializer(this, objectIdReader);
    }

    @Override // com.fasterxml.jackson.databind.deser.BeanDeserializerBase
    /* renamed from: withIgnorableProperties */
    public BeanDeserializer mo257withIgnorableProperties(Set<String> set) {
        ...
        while (str2 != null) {
            ...
            if (find != null) {
                ...
                try {
                    ...
                    asParser.nextToken();
                    this._anySetter.deserializeAndSet(asParser, deserializationContext, createUsingDefault, str2);
                } catch (Exception e2) {

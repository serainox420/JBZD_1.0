...
public interface zzaqd extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzaqd {
        ...
        /* loaded from: classes2.dex */
        private static class C0252zza implements zzaqd {
        ...
        public static zzaqd asInterface(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof zzaqd)) ? new C0252zza(iBinder) : (zzaqd) queryLocalInterface;
        }

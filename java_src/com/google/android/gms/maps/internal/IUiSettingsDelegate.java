...
public interface IUiSettingsDelegate extends IInterface {
    ...
    public static abstract class zza extends Binder implements IUiSettingsDelegate {
        ...
        /* loaded from: classes2.dex */
        private static class C0430zza implements IUiSettingsDelegate {
            private IBinder zzrk;

            C0430zza(IBinder iBinder) {
                this.zzrk = iBinder;
            }
        ...
        public static IUiSettingsDelegate zzeg(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof IUiSettingsDelegate)) ? new C0430zza(iBinder) : (IUiSettingsDelegate) queryLocalInterface;
        }

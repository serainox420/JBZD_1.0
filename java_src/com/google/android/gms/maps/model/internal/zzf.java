...
public interface zzf extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzf {
        ...
        /* loaded from: classes2.dex */
        public static class C0470zza implements zzf {
            private IBinder zzrk;

            C0470zza(IBinder iBinder) {
                this.zzrk = iBinder;
            }
        ...
        public static zzf zzen(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof zzf)) ? new C0470zza(iBinder) : (zzf) queryLocalInterface;
        }
        ...
        public boolean onTransact(int i, Parcel parcel, Parcel parcel2, int i2) throws RemoteException {
            ...
            switch (i) {
                ...
                case 16:
                    parcel.enforceInterface("com.google.android.gms.maps.model.internal.IMarkerDelegate");
                    boolean zzj = zzj(zzen(parcel.readStrongBinder()));
                    parcel2.writeNoException();
                    if (zzj) {
                        i7 = 1;
                    }

...
public interface zzcb extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzcb {
        ...
        /* loaded from: classes2.dex */
        private static class C0316zza implements zzcb {
            private IBinder zzrk;

            C0316zza(IBinder iBinder) {
                this.zzrk = iBinder;
            }
        ...
        public static zzcb zza(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof zzcb)) ? new C0316zza(iBinder) : (zzcb) queryLocalInterface;
        }

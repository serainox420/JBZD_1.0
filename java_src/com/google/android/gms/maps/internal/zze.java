...
public interface zze extends IInterface {
    ...
    public static abstract class zza extends Binder implements zze {
        ...
        /* loaded from: classes2.dex */
        private static class C0441zza implements zze {
            private IBinder zzrk;

            C0441zza(IBinder iBinder) {
                this.zzrk = iBinder;
            }
        ...
        public static zze zzdz(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof zze)) ? new C0441zza(iBinder) : (zze) queryLocalInterface;
        }

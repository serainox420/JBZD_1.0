...
public interface zzabb extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzabb {
        ...
        /* loaded from: classes2.dex */
        private static class C0198zza implements zzabb {
        ...
        public static zzabb zzbp(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof zzabb)) ? new C0198zza(iBinder) : (zzabb) queryLocalInterface;
        }

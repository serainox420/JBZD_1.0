...
public interface zzeo extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzeo {
        ...
        /* loaded from: classes2.dex */
        private static class C0321zza implements zzeo {
            private IBinder zzrk;

            C0321zza(IBinder iBinder) {
                this.zzrk = iBinder;
            }
        ...
        public static zzeo zzl(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof zzeo)) ? new C0321zza(iBinder) : (zzeo) queryLocalInterface;
        }

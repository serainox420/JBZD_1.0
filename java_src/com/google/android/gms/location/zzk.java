...
public interface zzk extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzk {
        ...
        /* loaded from: classes2.dex */
        private static class C0420zza implements zzk {
            private IBinder zzrk;

            C0420zza(IBinder iBinder) {
                this.zzrk = iBinder;
            }
        ...
        public static zzk zzde(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof zzk)) ? new C0420zza(iBinder) : (zzk) queryLocalInterface;
        }

...
public class zzapu {
    private static final ThreadLocal<String> zzaVn = new ThreadLocal<>();

    public static boolean zzCK() {
        String str = zzaVn.get();
    ...
    public static String zzL(String str, String str2) {
        ...
        return Integer.toHexString(zza(bArr, 0, bArr.length, 0));
    }

    private static int zza(byte[] bArr, int i, int i2, int i3) {
        int i4;
        int i5 = i + (i2 & (-4));
        int i6 = i3;
        while (i < i5) {
    ...
    public static String zzek(String str) {
        return zzCK() ? str : zzL(str, zzaVn.get());
    }
}

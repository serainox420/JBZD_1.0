...
public interface zzaz extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzaz {
        ...
        /* renamed from: com.google.android.gms.tagmanager.zzaz$zza$zza  reason: collision with other inner class name */
        /* loaded from: classes2.dex */
        private static class C0487zza implements zzaz {
        ...
        public static zzaz zzfi(IBinder iBinder) {
            if (iBinder == null) {
                return null;
            }
            IInterface queryLocalInterface = iBinder.queryLocalInterface("com.google.android.gms.tagmanager.IMeasurementEventListener");
            return (queryLocalInterface == null || !(queryLocalInterface instanceof zzaz)) ? new C0487zza(iBinder) : (zzaz) queryLocalInterface;
        }

...
public final class BaseSettings implements Serializable {
    ...
    public BaseSettings withVisibility(PropertyAccessor propertyAccessor, JsonAutoDetect.Visibility visibility) {
        return new BaseSettings(this._classIntrospector, this._annotationIntrospector, this._visibilityChecker.mo362withVisibility(propertyAccessor, visibility), this._propertyNamingStrategy, this._typeFactory, this._typeResolverBuilder, this._dateFormat, this._handlerInstantiator, this._locale, this._timeZone, this._defaultBase64);
    }
    ...
    public BaseSettings withDateFormat(DateFormat dateFormat) {
        ...
        return new BaseSettings(this._classIntrospector, this._annotationIntrospector, this._visibilityChecker, this._propertyNamingStrategy, this._typeFactory, this._typeResolverBuilder, (dateFormat == null || !hasExplicitTimeZone()) ? dateFormat : _force(dateFormat, this._timeZone), this._handlerInstantiator, this._locale, this._timeZone, this._defaultBase64);
    }

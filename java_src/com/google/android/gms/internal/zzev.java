...
public interface zzev extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzev {
        ...
        /* loaded from: classes2.dex */
        private static class C0328zza implements zzev {
            private IBinder zzrk;

            C0328zza(IBinder iBinder) {
                this.zzrk = iBinder;
            }
        ...
        public static zzev zzs(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof zzev)) ? new C0328zza(iBinder) : (zzev) queryLocalInterface;
        }

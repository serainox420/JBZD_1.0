...
public interface zzlg extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzlg {
        ...
        /* loaded from: classes2.dex */
        private static class C0366zza implements zzlg {
            private IBinder zzrk;

            C0366zza(IBinder iBinder) {
                this.zzrk = iBinder;
            }
        ...
        public static zzlg zzZ(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof zzlg)) ? new C0366zza(iBinder) : (zzlg) queryLocalInterface;
        }

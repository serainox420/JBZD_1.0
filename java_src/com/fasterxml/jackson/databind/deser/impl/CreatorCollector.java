...
public class CreatorCollector {
    ...
    private <T extends AnnotatedMember> T _fixAccess(T t) {
        if (t != null && this._canFixAccess) {
            ClassUtil.checkAndFixAccess((Member) t.mo354getAnnotated(), this._forceAccess);
        }
        return t;
    }
    ...
    protected static final class StdTypeConstructor extends AnnotatedWithParams implements Serializable {
        ...
        public Member mo333getMember() {
            return this._base.mo333getMember();
        }
        ...
        public AnnotatedElement mo354getAnnotated() {
            return this._base.mo354getAnnotated();
        }

        /* JADX INFO: Access modifiers changed from: protected */
        @Override // com.fasterxml.jackson.databind.introspect.Annotated
        public int getModifiers() {
            return this._base.mo333getMember().getModifiers();
        }

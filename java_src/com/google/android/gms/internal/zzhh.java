...
public interface zzhh extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzhh {
        ...
        /* loaded from: classes2.dex */
        private static class C0339zza implements zzhh {
            private IBinder zzrk;

            C0339zza(IBinder iBinder) {
                this.zzrk = iBinder;
            }
        ...
        public static zzhh zzC(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof zzhh)) ? new C0339zza(iBinder) : (zzhh) queryLocalInterface;
        }

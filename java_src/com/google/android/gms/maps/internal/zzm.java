...
public interface zzm extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzm {
        ...
        /* loaded from: classes2.dex */
        private static class C0449zza implements zzm {
            private IBinder zzrk;

            C0449zza(IBinder iBinder) {
                this.zzrk = iBinder;
            }
        ...
        public static zzm zzdH(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof zzm)) ? new C0449zza(iBinder) : (zzm) queryLocalInterface;
        }

...
public class BeanAsArrayDeserializer extends BeanDeserializerBase {
    ...
    public BeanDeserializerBase mo258withObjectIdReader(ObjectIdReader objectIdReader) {
        return new BeanAsArrayDeserializer(this._delegate.mo258withObjectIdReader(objectIdReader), this._orderedProperties);
    }

    @Override // com.fasterxml.jackson.databind.deser.BeanDeserializerBase
    /* renamed from: withIgnorableProperties */
    public BeanDeserializerBase mo257withIgnorableProperties(Set<String> set) {
        return new BeanAsArrayDeserializer(this._delegate.mo257withIgnorableProperties(set), this._orderedProperties);
    }

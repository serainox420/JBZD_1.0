...
public interface zznt extends IInterface {
    ...
    public static abstract class zza extends Binder implements zznt {
        ...
        /* loaded from: classes2.dex */
        private static class C0375zza implements zznt {
            private IBinder zzrk;

            C0375zza(IBinder iBinder) {
                this.zzrk = iBinder;
            }
        ...
        public static zznt zzag(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof zznt)) ? new C0375zza(iBinder) : (zznt) queryLocalInterface;
        }

...
public interface zzhs extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzhs {
        ...
        /* loaded from: classes2.dex */
        private static class C0347zza implements zzhs {
            private IBinder zzrk;

            C0347zza(IBinder iBinder) {
                this.zzrk = iBinder;
            }
        ...
        public static zzhs zzK(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof zzhs)) ? new C0347zza(iBinder) : (zzhs) queryLocalInterface;
        }

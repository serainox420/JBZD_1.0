...
public interface zzamd extends IInterface {
    ...
    /* loaded from: classes2.dex */
    public static abstract class zza extends Binder implements zzamd {

        /* renamed from: com.google.android.gms.internal.zzamd$zza$zza  reason: collision with other inner class name */
        /* loaded from: classes2.dex */
        private static class C0214zza implements zzamd {
        ...
        public static zzamd zzbP(IBinder iBinder) {
            if (iBinder == null) {
                return null;
            }
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof zzamd)) ? new C0214zza(iBinder) : (zzamd) queryLocalInterface;
        }

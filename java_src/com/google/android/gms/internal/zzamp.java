...
public interface zzamp extends IInterface {
    ...
    /* loaded from: classes2.dex */
    public static abstract class zza extends Binder implements zzamp {

        /* renamed from: com.google.android.gms.internal.zzamp$zza$zza  reason: collision with other inner class name */
        /* loaded from: classes2.dex */
        private static class C0226zza implements zzamp {
        ...
        public static zzamp zzcb(IBinder iBinder) {
            if (iBinder == null) {
                return null;
            }
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof zzamp)) ? new C0226zza(iBinder) : (zzamp) queryLocalInterface;
        }

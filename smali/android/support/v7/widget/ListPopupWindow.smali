...
.method private b()I
    ...
    :goto_0
    invoke-virtual {p0, v5, v0}, Landroid/support/v7/widget/ListPopupWindow;->a(Landroid/content/Context;Z)Landroid/support/v7/widget/x;

    move-result-object v0

    iput-object v0, p0, Landroid/support/v7/widget/ListPopupWindow;->c:Landroid/support/v7/widget/x;
    ...
    invoke-virtual {v0, v6}, Landroid/support/v7/widget/x;->setSelector(Landroid/graphics/drawable/Drawable;)V
    ...
    invoke-virtual {v0, v6}, Landroid/support/v7/widget/x;->setAdapter(Landroid/widget/ListAdapter;)V
    ...
    invoke-virtual {v0, v6}, Landroid/support/v7/widget/x;->setOnItemClickListener(Landroid/widget/AdapterView$OnItemClickListener;)V
    ...
    invoke-virtual {v0, v6}, Landroid/support/v7/widget/x;->setOnItemSelectedListener(Landroid/widget/AdapterView$OnItemSelectedListener;)V
    ...
    invoke-virtual {v0, v6}, Landroid/support/v7/widget/x;->setOnScrollListener(Landroid/widget/AbsListView$OnScrollListener;)V
    ...
    .line 1291
    iget-object v1, p0, Landroid/support/v7/widget/ListPopupWindow;->c:Landroid/support/v7/widget/x;

    invoke-virtual {v1}, Landroid/support/v7/widget/x;->getPaddingTop()I
    ...
    .line 1292
    invoke-virtual {v2}, Landroid/support/v7/widget/x;->getPaddingBottom()I
...
.method public d()V
    ...
    invoke-virtual {v0, v5}, Landroid/support/v7/widget/x;->setSelection(I)V

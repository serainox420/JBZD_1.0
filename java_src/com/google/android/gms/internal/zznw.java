...
public interface zznw extends IInterface {
    ...
    public static abstract class zza extends Binder implements zznw {
        ...
        /* loaded from: classes2.dex */
        private static class C0378zza implements zznw {
            private IBinder zzrk;

            C0378zza(IBinder iBinder) {
                this.zzrk = iBinder;
            }
        ...
        public static zznw zzaj(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof zznw)) ? new C0378zza(iBinder) : (zznw) queryLocalInterface;
        }
    ...
    void zza(zznt zzntVar) throws RemoteException;
}

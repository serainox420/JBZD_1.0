...
public final class PlusShare {
    ...
    public static class Builder {
        ...
        public Builder addCallToAction(String str, Uri uri, String str2) {
            zzac.zza(this.zzbBR, "Must include the launching activity with PlusShare.Builder constructor before setting call-to-action");
            zzac.zzb(uri != null && !TextUtils.isEmpty(uri.toString()), "Must provide a call to action URL");
            ...
            if (!TextUtils.isEmpty(str2)) {
                zzac.zza(PlusShare.zzgo(str2), "The specified deep-link ID was malformed.");
        ...
        public Intent getIntent() {
            ...
            zzac.zza(!z2 || !booleanExtra, "Call-to-action buttons are only available for URLs.");
            zzac.zza(!booleanExtra || this.mIntent.hasExtra(PlusShare.EXTRA_CONTENT_URL), "The content URL is required for interactive posts.");
            ...
            zzac.zza(z, "Must set content URL or content deep-link ID to use a call-to-action button.");
            if (this.mIntent.hasExtra(PlusShare.EXTRA_CONTENT_DEEP_LINK_ID)) {
                zzac.zza(PlusShare.zzgo(this.mIntent.getStringExtra(PlusShare.EXTRA_CONTENT_DEEP_LINK_ID)), "The specified deep-link ID was malformed.");
            }
            if (!z2 && equals) {
                ...
                if (this.zzbBS == null || this.zzbBS.isEmpty()) {
                    ...
                    this.mIntent.putExtra("android.intent.extra.STREAM", this.zzbBS.get(0));
                }
                this.zzbBS = null;
            }
            if (z2 && !equals) {
        ...
        public Builder setContentDeepLinkId(String str, String str2, String str3, Uri uri) {
            zzac.zzb(this.zzbBR, "Must include the launching activity with PlusShare.Builder constructor before setting deep links");
            zzac.zzb(!TextUtils.isEmpty(str), "The deepLinkId parameter is required.");

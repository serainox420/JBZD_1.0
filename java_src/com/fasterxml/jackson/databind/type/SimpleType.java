...
public class SimpleType extends TypeBase {
    ...
    public SimpleType mo472withTypeHandler(Object obj) {
    ...
    public SimpleType mo473withValueHandler(Object obj) {
    ...
    public SimpleType mo470withContentValueHandler(Object obj) {
        throw new IllegalArgumentException("Simple types have no content types; can not call withContenValueHandler()");
    }

    @Override // com.fasterxml.jackson.databind.JavaType
    /* renamed from: withStaticTyping  reason: collision with other method in class */
    public SimpleType mo471withStaticTyping() {
    ...
    protected String buildCanonicalName() {
        ...
        if (size > 0) {
            ...
            for (int i = 0; i < size; i++) {
                JavaType containedType = mo474containedType(i);
                if (i > 0) {
                    sb.append(',');
                }
    ...
    public StringBuilder getGenericSignature(StringBuilder sb) {
        ...
        if (size > 0) {
            sb.append('<');
            for (int i = 0; i < size; i++) {
                sb = mo474containedType(i).getGenericSignature(sb);
            }
            sb.append('>');
        }
        sb.append(';');

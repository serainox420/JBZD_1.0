...
public interface zzgo extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzgo {
        ...
        /* loaded from: classes2.dex */
        private static class C0335zza implements zzgo {
            private IBinder zzrk;

            C0335zza(IBinder iBinder) {
                this.zzrk = iBinder;
            }
        ...
        public static zzgo zzz(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof zzgo)) ? new C0335zza(iBinder) : (zzgo) queryLocalInterface;
        }

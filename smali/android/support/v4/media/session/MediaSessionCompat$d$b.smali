...
.method public f()Landroid/support/v4/media/session/ParcelableVolumeInfo;
    ...
    iget-object v0, v0, Landroid/support/v4/media/session/MediaSessionCompat$d;->t:Landroid/support/v4/media/f;

    .line 2128
    if-ne v1, v3, :cond_0

    .line 2129
    invoke-virtual {v0}, Landroid/support/v4/media/f;->b()I

    move-result v3

    .line 2130
    invoke-virtual {v0}, Landroid/support/v4/media/f;->c()I

    move-result v4

    .line 2131
    invoke-virtual {v0}, Landroid/support/v4/media/f;->a()I
...
.method public h()Landroid/support/v4/media/session/PlaybackStateCompat;
    ...
    invoke-virtual {v0}, Landroid/support/v4/media/session/MediaSessionCompat$d;->e()Landroid/support/v4/media/session/PlaybackStateCompat;
...
.method public o()V
    ...
    invoke-virtual {v0, v1}, Landroid/support/v4/media/session/MediaSessionCompat$d;->c(I)V

...
public interface zzape extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzape {
        ...
        /* loaded from: classes2.dex */
        private static class C0246zza implements zzape {
        ...
        public static zzape zzcI(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof zzape)) ? new C0246zza(iBinder) : (zzape) queryLocalInterface;
        }

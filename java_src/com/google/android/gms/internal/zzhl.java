...
public interface zzhl extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzhl {
        ...
        /* loaded from: classes2.dex */
        private static class C0342zza implements zzhl {
            private IBinder zzrk;

            C0342zza(IBinder iBinder) {
                this.zzrk = iBinder;
            }
        ...
        public static zzhl zzF(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof zzhl)) ? new C0342zza(iBinder) : (zzhl) queryLocalInterface;
        }

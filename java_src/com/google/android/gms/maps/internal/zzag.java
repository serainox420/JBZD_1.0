...
public interface zzag extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzag {
        ...
        /* loaded from: classes2.dex */
        private static class C0437zza implements zzag {
            private IBinder zzrk;

            C0437zza(IBinder iBinder) {
                this.zzrk = iBinder;
            }
        ...
        public static zzag zzec(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof zzag)) ? new C0437zza(iBinder) : (zzag) queryLocalInterface;
        }

...
public class LocationServices {
    ...
    private static final Api.zza<zzash, Api.ApiOptions.NoOptions> zzaie = new Api.zza<zzash, Api.ApiOptions.NoOptions>() { // from class: com.google.android.gms.location.LocationServices.1
    ...
    public static zzash zzj(GoogleApiClient googleApiClient) {
        ...
        zzac.zza(z, "GoogleApiClient is not configured to use the LocationServices.API Api. Pass thisinto GoogleApiClient.Builder#addApi() to use this feature.");
        return zzashVar;
    }
}

...
.method zza(Landroid/app/Activity;Landroid/app/Dialog;Ljava/lang/String;Landroid/content/DialogInterface$OnCancelListener;)V
    ...
    invoke-virtual {p1}, Landroid/support/v4/app/FragmentActivity;->getSupportFragmentManager()Landroid/support/v4/app/u;
    ...
    invoke-virtual {v1, v0, p3}, Lcom/google/android/gms/common/SupportErrorDialogFragment;->show(Landroid/support/v4/app/u;Ljava/lang/String;)V
...
.method zza(Landroid/content/Context;ILjava/lang/String;Landroid/app/PendingIntent;)V
    ...
    invoke-direct {v3, p1}, Landroid/support/v4/app/aj$d;-><init>(Landroid/content/Context;)V

    const v4, 0x108008a

    invoke-virtual {v3, v4}, Landroid/support/v4/app/aj$d;->a(I)Landroid/support/v4/app/aj$d;
    ...
    invoke-virtual {v3, v2}, Landroid/support/v4/app/aj$d;->c(Ljava/lang/CharSequence;)Landroid/support/v4/app/aj$d;
    ...
    invoke-virtual {v2, v4, v5}, Landroid/support/v4/app/aj$d;->a(J)Landroid/support/v4/app/aj$d;

    move-result-object v2

    invoke-virtual {v2, v6}, Landroid/support/v4/app/aj$d;->c(Z)Landroid/support/v4/app/aj$d;

    move-result-object v2

    invoke-virtual {v2, p4}, Landroid/support/v4/app/aj$d;->a(Landroid/app/PendingIntent;)Landroid/support/v4/app/aj$d;

    move-result-object v2

    invoke-virtual {v2, v0}, Landroid/support/v4/app/aj$d;->a(Ljava/lang/CharSequence;)Landroid/support/v4/app/aj$d;
    ...
    invoke-virtual {v0, v6}, Landroid/support/v4/app/aj$d;->d(Z)Landroid/support/v4/app/aj$d;
    ...
    invoke-virtual {v2, v1}, Landroid/support/v4/app/aj$c;->a(Ljava/lang/CharSequence;)Landroid/support/v4/app/aj$c;

    move-result-object v1

    invoke-virtual {v0, v1}, Landroid/support/v4/app/aj$d;->a(Landroid/support/v4/app/aj$q;)Landroid/support/v4/app/aj$d;

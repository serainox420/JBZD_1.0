...
.method public constructor <init>(Landroid/support/v4/app/j;)V
    ...
    .line 48
    iget-object v1, p1, Landroid/support/v4/app/j;->c:Ljava/util/ArrayList;
    ...
    .line 51
    iget-boolean v1, p1, Landroid/support/v4/app/j;->j:Z
    ...
    .line 57
    iget-object v0, p1, Landroid/support/v4/app/j;->c:Ljava/util/ArrayList;
    ...
    .line 66
    iget v0, p1, Landroid/support/v4/app/j;->i:I

    iput v0, p0, Landroid/support/v4/app/BackStackState;->c:I

    .line 67
    iget-object v0, p1, Landroid/support/v4/app/j;->l:Ljava/lang/String;
    ...
    .line 69
    iget v0, p1, Landroid/support/v4/app/j;->o:I

    iput v0, p0, Landroid/support/v4/app/BackStackState;->f:I

    .line 70
    iget-object v0, p1, Landroid/support/v4/app/j;->p:Ljava/lang/CharSequence;

    iput-object v0, p0, Landroid/support/v4/app/BackStackState;->g:Ljava/lang/CharSequence;

    .line 71
    iget v0, p1, Landroid/support/v4/app/j;->q:I

    iput v0, p0, Landroid/support/v4/app/BackStackState;->h:I

    .line 72
    iget-object v0, p1, Landroid/support/v4/app/j;->r:Ljava/lang/CharSequence;
    ...
    .line 74
    iget-object v0, p1, Landroid/support/v4/app/j;->t:Ljava/util/ArrayList;

    iput-object v0, p0, Landroid/support/v4/app/BackStackState;->k:Ljava/util/ArrayList;

    .line 75
    iget-boolean v0, p1, Landroid/support/v4/app/j;->u:Z
...
# virtual methods
.method public a(Landroid/support/v4/app/v;)Landroid/support/v4/app/j;
    .locals 8
    ...
    invoke-direct {v3, p1}, Landroid/support/v4/app/j;-><init>(Landroid/support/v4/app/v;)V
    ...
    .line 104
    iget-object v5, p1, Landroid/support/v4/app/v;->e:Ljava/util/ArrayList;
    ...
    iput v0, v3, Landroid/support/v4/app/j;->d:I

    .line 114
    iget v0, v4, Landroid/support/v4/app/j$a;->d:I

    iput v0, v3, Landroid/support/v4/app/j;->e:I

    .line 115
    iget v0, v4, Landroid/support/v4/app/j$a;->e:I

    iput v0, v3, Landroid/support/v4/app/j;->f:I

    .line 116
    iget v0, v4, Landroid/support/v4/app/j$a;->f:I

    iput v0, v3, Landroid/support/v4/app/j;->g:I
    ...
    iput v0, v3, Landroid/support/v4/app/j;->h:I

    .line 121
    iget v0, p0, Landroid/support/v4/app/BackStackState;->c:I

    iput v0, v3, Landroid/support/v4/app/j;->i:I

    .line 122
    iget-object v0, p0, Landroid/support/v4/app/BackStackState;->d:Ljava/lang/String;

    iput-object v0, v3, Landroid/support/v4/app/j;->l:Ljava/lang/String;

    .line 123
    iget v0, p0, Landroid/support/v4/app/BackStackState;->e:I

    iput v0, v3, Landroid/support/v4/app/j;->n:I

    .line 124
    iput-boolean v7, v3, Landroid/support/v4/app/j;->j:Z
    ...
    iput-object v0, v3, Landroid/support/v4/app/j;->p:Ljava/lang/CharSequence;
    ...
    iput-object v0, v3, Landroid/support/v4/app/j;->r:Ljava/lang/CharSequence;

    .line 129
    iget-object v0, p0, Landroid/support/v4/app/BackStackState;->j:Ljava/util/ArrayList;

    iput-object v0, v3, Landroid/support/v4/app/j;->s:Ljava/util/ArrayList;

    .line 130
    iget-object v0, p0, Landroid/support/v4/app/BackStackState;->k:Ljava/util/ArrayList;

    iput-object v0, v3, Landroid/support/v4/app/j;->t:Ljava/util/ArrayList;

    .line 131
    iget-boolean v0, p0, Landroid/support/v4/app/BackStackState;->l:Z

    iput-boolean v0, v3, Landroid/support/v4/app/j;->u:Z

    .line 132
    invoke-virtual {v3, v7}, Landroid/support/v4/app/j;->a(I)V

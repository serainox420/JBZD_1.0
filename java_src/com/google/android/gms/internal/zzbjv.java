...
public interface zzbjv extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzbjv {
        ...
        /* renamed from: com.google.android.gms.internal.zzbjv$zza$zza  reason: collision with other inner class name */
        /* loaded from: classes2.dex */
        private static class C0293zza implements zzbjv {
            private IBinder zzrk;

            C0293zza(IBinder iBinder) {
                this.zzrk = iBinder;
            }
            ...
            @Override // com.google.android.gms.internal.zzbjv
            ...
            @Override // com.google.android.gms.internal.zzbjv
            public zzbjr[] zzc(IObjectWrapper iObjectWrapper, zzbka zzbkaVar) throws RemoteException {
                Parcel obtain = Parcel.obtain();
                Parcel obtain2 = Parcel.obtain();
                try {
                    obtain.writeInterfaceToken("com.google.android.gms.vision.face.internal.client.INativeFaceDetector");
                    ...
                    obtain2.readException();
                    return (zzbjr[]) obtain2.createTypedArray(zzbjr.CREATOR);
                } finally {
                    obtain2.recycle();
                    obtain.recycle();
                }
        ...
        public static zzbjv zzfp(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof zzbjv)) ? new C0293zza(iBinder) : (zzbjv) queryLocalInterface;
        }
        ...
        public boolean onTransact(int i, Parcel parcel, Parcel parcel2, int i2) throws RemoteException {
            switch (i) {
                case 1:
                    ...
                    zzbjr[] zzc = zzc(IObjectWrapper.zza.zzcd(parcel.readStrongBinder()), parcel.readInt() != 0 ? zzbka.CREATOR.createFromParcel(parcel) : null);
    ...
    zzbjr[] zzc(IObjectWrapper iObjectWrapper, zzbka zzbkaVar) throws RemoteException;

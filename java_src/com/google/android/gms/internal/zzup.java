...
public interface zzup extends IInterface {

    /* loaded from: classes2.dex */
    public static abstract class zza extends Binder implements zzup {

        /* renamed from: com.google.android.gms.internal.zzup$zza$zza  reason: collision with other inner class name */
        /* loaded from: classes2.dex */
        private static class C0387zza implements zzup {
            private IBinder zzrk;

            C0387zza(IBinder iBinder) {
                this.zzrk = iBinder;
            }
        ...
        public static zzup zzar(IBinder iBinder) {
            if (iBinder == null) {
                return null;
            }
            IInterface queryLocalInterface = iBinder.queryLocalInterface("com.google.android.gms.appinvite.internal.IAppInviteCallbacks");
            return (queryLocalInterface == null || !(queryLocalInterface instanceof zzup)) ? new C0387zza(iBinder) : (zzup) queryLocalInterface;
        }
        ...
        public boolean onTransact(int i, Parcel parcel, Parcel parcel2, int i2) throws RemoteException {
            switch (i) {
                case 1:
                    ...
                    zzd(parcel.readInt() != 0 ? Status.CREATOR.createFromParcel(parcel) : null);

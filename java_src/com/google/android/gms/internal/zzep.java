...
public interface zzep extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzep {
        ...
        /* loaded from: classes2.dex */
        private static class C0322zza implements zzep {
            private IBinder zzrk;

            C0322zza(IBinder iBinder) {
                this.zzrk = iBinder;
            }
        ...
        public static zzep zzm(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof zzep)) ? new C0322zza(iBinder) : (zzep) queryLocalInterface;
        }

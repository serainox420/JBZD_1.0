...
public final class zzak extends Button {
    ...
    private void zzb(Resources resources, int i, int i2) {
        Drawable g = a.g(resources.getDrawable(zze(i, zzg(i2, R.drawable.common_google_signin_btn_icon_dark, R.drawable.common_google_signin_btn_icon_light, R.drawable.common_google_signin_btn_icon_light), zzg(i2, R.drawable.common_google_signin_btn_text_dark, R.drawable.common_google_signin_btn_text_light, R.drawable.common_google_signin_btn_text_light))));
        a.a(g, resources.getColorStateList(R.color.common_google_signin_btn_tint));

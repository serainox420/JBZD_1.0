...
public interface zzasf extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzasf {
        ...
        /* loaded from: classes2.dex */
        private static class C0263zza implements zzasf {
        ...
        public static zzasf zzdj(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof zzasf)) ? new C0263zza(iBinder) : (zzasf) queryLocalInterface;
        }

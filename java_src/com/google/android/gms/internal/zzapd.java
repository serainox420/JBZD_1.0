...
public interface zzapd extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzapd {
        ...
        /* loaded from: classes2.dex */
        private static class C0245zza implements zzapd {
        ...
        public static zzapd zzcH(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof zzapd)) ? new C0245zza(iBinder) : (zzapd) queryLocalInterface;
        }

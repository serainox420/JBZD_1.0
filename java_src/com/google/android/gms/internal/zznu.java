...
public interface zznu extends IInterface {
    ...
    public static abstract class zza extends Binder implements zznu {
        ...
        /* loaded from: classes2.dex */
        private static class C0376zza implements zznu {
            private IBinder zzrk;

            C0376zza(IBinder iBinder) {
                this.zzrk = iBinder;
            }
            ...
            public void zza(zzoa zzoaVar) throws RemoteException {
                ...
                try {
                    ...
                    if (zzoaVar != null) {
                        obtain.writeInt(1);
                        zzoaVar.writeToParcel(obtain, 0);
                    } else {
                        obtain.writeInt(0);
                    }
        ...
        public static zznu zzah(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof zznu)) ? new C0376zza(iBinder) : (zznu) queryLocalInterface;
        }

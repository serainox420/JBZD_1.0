...
public interface zzac extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzac {
        ...
        /* loaded from: classes2.dex */
        private static class C0433zza implements zzac {
            private IBinder zzrk;

            C0433zza(IBinder iBinder) {
                this.zzrk = iBinder;
            }
        ...
        public static zzac zzdX(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof zzac)) ? new C0433zza(iBinder) : (zzac) queryLocalInterface;
        }

...
public interface ILocationSourceDelegate extends IInterface {
    ...
    public static abstract class zza extends Binder implements ILocationSourceDelegate {
        ...
        /* loaded from: classes2.dex */
        private static class C0423zza implements ILocationSourceDelegate {
            private IBinder zzrk;

            C0423zza(IBinder iBinder) {
                this.zzrk = iBinder;
            }
        ...
        public static ILocationSourceDelegate zzdw(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof ILocationSourceDelegate)) ? new C0423zza(iBinder) : (ILocationSourceDelegate) queryLocalInterface;
        }

...
public interface zzy extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzy {
        ...
        /* loaded from: classes2.dex */
        private static class C0182zza implements zzy {
            ...
            @Override // com.google.android.gms.common.internal.zzy
            public IObjectWrapper zza(IObjectWrapper iObjectWrapper, zzah zzahVar) throws RemoteException {
                Parcel obtain = Parcel.obtain();
                Parcel obtain2 = Parcel.obtain();
                try {
                    obtain.writeInterfaceToken("com.google.android.gms.common.internal.ISignInButtonCreator");
        ...
        public static zzy zzbx(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof zzy)) ? new C0182zza(iBinder) : (zzy) queryLocalInterface;
        }
    ...
    IObjectWrapper zza(IObjectWrapper iObjectWrapper, zzah zzahVar) throws RemoteException;
}

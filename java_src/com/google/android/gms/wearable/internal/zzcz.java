...
public class zzcz {
    ...
    private PackageInfo zzir(String str) {
        try {
            ...
            Log.w("WearSignatureVerifier", valueOf.length() != 0 ? "No package ".concat(valueOf) : new String("No package "));
            return null;
        }
    }
    ...
    boolean zzc(PackageInfo packageInfo, boolean z) {
        ...
        return z ? zza(packageInfo, zzbVq, zzbVr) : zza(packageInfo, zzbVq);
    }

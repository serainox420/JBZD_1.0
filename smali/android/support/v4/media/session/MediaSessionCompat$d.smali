...
.field private E:Landroid/support/v4/media/f$a;
...
.field t:Landroid/support/v4/media/f;
...
.method public constructor <init>(Landroid/content/Context;Ljava/lang/String;Landroid/content/ComponentName;Landroid/app/PendingIntent;)V
    ...
    iput-object v0, p0, Landroid/support/v4/media/session/MediaSessionCompat$d;->E:Landroid/support/v4/media/f$a;
    ...
    .line 1523
    invoke-static {p4}, Landroid/support/v4/media/session/d;->a(Landroid/app/PendingIntent;)Ljava/lang/Object;
...
.method private f()Z
    ...
    invoke-static {v0, v3, v4}, Landroid/support/v4/media/session/e;->a(Landroid/content/Context;Landroid/app/PendingIntent;Landroid/content/ComponentName;)V
    ...
    invoke-static {v0, v2}, Landroid/support/v4/media/session/d;->a(Landroid/content/Context;Ljava/lang/Object;)V
    ...
    invoke-static {v0, v3, v4}, Landroid/support/v4/media/session/e;->b(Landroid/content/Context;Landroid/app/PendingIntent;Landroid/content/ComponentName;)V
    ...
    invoke-static {v0, v2}, Landroid/support/v4/media/session/d;->a(Ljava/lang/Object;I)V
    ...
    invoke-static {v0, v1}, Landroid/support/v4/media/session/d;->b(Landroid/content/Context;Ljava/lang/Object;)V
    ...
    invoke-static {v0, v1, v3}, Landroid/support/v4/media/session/e;->b(Landroid/content/Context;Landroid/app/PendingIntent;Landroid/content/ComponentName;)V
...
.method public a(I)V
    ...
    .line 1608
    invoke-direct {p0}, Landroid/support/v4/media/session/MediaSessionCompat$d;->f()Z
...
.method public a(Landroid/support/v4/media/MediaMetadataCompat;)V
    ...
    invoke-direct {v1, p1, v2}, Landroid/support/v4/media/MediaMetadataCompat$a;-><init>(Landroid/support/v4/media/MediaMetadataCompat;I)V
    ...
    .line 1729
    :goto_2
    invoke-static {v1, v0, v2, v3}, Landroid/support/v4/media/session/f;->a(Ljava/lang/Object;Landroid/os/Bundle;J)V
    ...
    :goto_3
    invoke-static {v1, v0}, Landroid/support/v4/media/session/d;->a(Ljava/lang/Object;Landroid/os/Bundle;)V
...
.method public a(Landroid/support/v4/media/f;)V
    ...
    .line 1629
    :cond_0
    iget-object v0, p0, Landroid/support/v4/media/session/MediaSessionCompat$d;->t:Landroid/support/v4/media/f;
    ...
    invoke-virtual {v0, v1}, Landroid/support/v4/media/f;->a(Landroid/support/v4/media/f$a;)V
    ...
    .line 1633
    iput-object p1, p0, Landroid/support/v4/media/session/MediaSessionCompat$d;->t:Landroid/support/v4/media/f;
    ...
    iget-object v3, p0, Landroid/support/v4/media/session/MediaSessionCompat$d;->t:Landroid/support/v4/media/f;

    .line 1635
    invoke-virtual {v3}, Landroid/support/v4/media/f;->b()I

    move-result v3

    iget-object v4, p0, Landroid/support/v4/media/session/MediaSessionCompat$d;->t:Landroid/support/v4/media/f;

    invoke-virtual {v4}, Landroid/support/v4/media/f;->c()I

    move-result v4

    iget-object v5, p0, Landroid/support/v4/media/session/MediaSessionCompat$d;->t:Landroid/support/v4/media/f;

    .line 1636
    invoke-virtual {v5}, Landroid/support/v4/media/f;->a()I
    ...
    .line 1639
    iget-object v0, p0, Landroid/support/v4/media/session/MediaSessionCompat$d;->E:Landroid/support/v4/media/f$a;

    invoke-virtual {p1, v0}, Landroid/support/v4/media/f;->a(Landroid/support/v4/media/f$a;)V
...
.method public a(Landroid/support/v4/media/session/MediaSessionCompat$a;Landroid/os/Handler;)V
    ...
    invoke-static {v0, v1}, Landroid/support/v4/media/session/e;->a(Ljava/lang/Object;Ljava/lang/Object;)V
    ...
    invoke-static {v2, v1}, Landroid/support/v4/media/session/e;->a(Ljava/lang/Object;Ljava/lang/Object;)V
    ...
    invoke-static {v1, v0}, Landroid/support/v4/media/session/f;->a(Ljava/lang/Object;Ljava/lang/Object;)V
...
.method public a(Landroid/support/v4/media/session/PlaybackStateCompat;)V
    ...
    invoke-static {v0, v1}, Landroid/support/v4/media/session/d;->a(Ljava/lang/Object;I)V
    ...
    invoke-static {v0, v2, v3}, Landroid/support/v4/media/session/d;->a(Ljava/lang/Object;J)V
    ...
    .line 1695
    invoke-static/range {v0 .. v6}, Landroid/support/v4/media/session/e;->a(Ljava/lang/Object;IJFJ)V
    ...
    invoke-static {v0, v2, v3}, Landroid/support/v4/media/session/e;->a(Ljava/lang/Object;J)V
...
.method public b()V
    ...
    .line 1669
    invoke-direct {p0}, Landroid/support/v4/media/session/MediaSessionCompat$d;->g()V
...
.method b(II)V
    ...
    invoke-virtual {v0, p1}, Landroid/support/v4/media/f;->c(I)V
...
.method c(II)V
    ...
    invoke-virtual {v0, p1}, Landroid/support/v4/media/f;->b(I)V
...
.method e()Landroid/support/v4/media/session/PlaybackStateCompat;
    .locals 12

...
public abstract class ay {
    private static int b = ByteConstants.MB;

    /* renamed from: a  reason: collision with root package name */
    private Matrix f251a;
    ...
    public Parcelable a(View view, Matrix matrix, RectF rectF) {
        ...
        if (this.f251a == null) {
            this.f251a = new Matrix();
        }
        this.f251a.set(matrix);
        this.f251a.postTranslate(-rectF.left, -rectF.top);
        this.f251a.postScale(min, min);
        Bitmap createBitmap = Bitmap.createBitmap(i, i2, Bitmap.Config.ARGB_8888);
        Canvas canvas = new Canvas(createBitmap);
        canvas.concat(this.f251a);
        view.draw(canvas);
        return createBitmap;
    }

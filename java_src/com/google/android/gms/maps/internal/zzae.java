...
public interface zzae extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzae {
        ...
        /* loaded from: classes2.dex */
        private static class C0435zza implements zzae {
        ...
        public static zzae zzdZ(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof zzae)) ? new C0435zza(iBinder) : (zzae) queryLocalInterface;
        }

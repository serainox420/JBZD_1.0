...
public final class GooglePlayServicesUtil extends zzg {
    ...
    public static boolean showErrorDialogFragment(int i, Activity activity, Fragment fragment, int i2, DialogInterface.OnCancelListener onCancelListener) {
        ...
        Dialog zza = googleApiAvailability.zza(activity, i, zzi.zza(fragment, GoogleApiAvailability.getInstance().zzb(activity, i, PhoenixConstants.DEBUG_PARAM), i2), onCancelListener);
        if (zza == null) {
            return false;
        }

...
public interface zzad extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzad {
        ...
        /* loaded from: classes2.dex */
        private static class C0434zza implements zzad {
            private IBinder zzrk;

            C0434zza(IBinder iBinder) {
                this.zzrk = iBinder;
            }
        ...
        public static zzad zzdY(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof zzad)) ? new C0434zza(iBinder) : (zzad) queryLocalInterface;
        }

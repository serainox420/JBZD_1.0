...
public class BeanAsArraySerializer extends BeanSerializerBase {
    ...
    protected /* bridge */ /* synthetic */ BeanSerializerBase mo422withIgnorals(Set set) {
        return mo422withIgnorals((Set<String>) set);
    }
    ...
    public BeanSerializerBase mo430withFilterId(Object obj) {
        return new BeanAsArraySerializer(this, this._objectIdWriter, obj);
    }

    @Override // com.fasterxml.jackson.databind.ser.std.BeanSerializerBase
    /* renamed from: withIgnorals */
    protected BeanAsArraySerializer mo422withIgnorals(Set<String> set) {

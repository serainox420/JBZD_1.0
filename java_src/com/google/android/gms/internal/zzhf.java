...
public interface zzhf extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzhf {
        ...
        /* loaded from: classes2.dex */
        private static class C0338zza implements zzhf {
            private IBinder zzrk;

            C0338zza(IBinder iBinder) {
                this.zzrk = iBinder;
            }
        ...
        public static zzhf zzB(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof zzhf)) ? new C0338zza(iBinder) : (zzhf) queryLocalInterface;
        }

...
.method public handleMessage(Landroid/os/Message;)V
    ...
    invoke-virtual {v1, v2, v3, v0}, Landroid/support/v4/media/session/MediaSessionCompat$a;->onCommand(Ljava/lang/String;Landroid/os/Bundle;Landroid/os/ResultReceiver;)V
    ...
    .line 2409
    invoke-virtual {v1, v2}, Landroid/support/v4/media/session/MediaSessionCompat$a;->onMediaButtonEvent(Landroid/content/Intent;)Z
    ...
    invoke-virtual {v1, v0, v2}, Landroid/support/v4/media/session/MediaSessionCompat$a;->onPrepareFromMediaId(Ljava/lang/String;Landroid/os/Bundle;)V
    ...
    invoke-virtual {v1, v0, v2}, Landroid/support/v4/media/session/MediaSessionCompat$a;->onPrepareFromSearch(Ljava/lang/String;Landroid/os/Bundle;)V
    ...
    invoke-virtual {v1, v0, v2}, Landroid/support/v4/media/session/MediaSessionCompat$a;->onPrepareFromUri(Landroid/net/Uri;Landroid/os/Bundle;)V
    ...
    invoke-virtual {v1, v0, v2}, Landroid/support/v4/media/session/MediaSessionCompat$a;->onPlayFromMediaId(Ljava/lang/String;Landroid/os/Bundle;)V
    ...
    invoke-virtual {v1, v0, v2}, Landroid/support/v4/media/session/MediaSessionCompat$a;->onPlayFromSearch(Ljava/lang/String;Landroid/os/Bundle;)V
    ...
    invoke-virtual {v1, v0, v2}, Landroid/support/v4/media/session/MediaSessionCompat$a;->onPlayFromUri(Landroid/net/Uri;Landroid/os/Bundle;)V
    ...
    invoke-virtual {v1, v2, v3}, Landroid/support/v4/media/session/MediaSessionCompat$a;->onSkipToQueueItem(J)V
    ...
    invoke-virtual {v1, v2, v3}, Landroid/support/v4/media/session/MediaSessionCompat$a;->onSeekTo(J)V
    ...
    invoke-virtual {v1, v0}, Landroid/support/v4/media/session/MediaSessionCompat$a;->onSetRating(Landroid/support/v4/media/RatingCompat;)V
    ...
    invoke-virtual {v1, v0, v2}, Landroid/support/v4/media/session/MediaSessionCompat$a;->onCustomAction(Ljava/lang/String;Landroid/os/Bundle;)V
    ...
    invoke-virtual {v1, v0}, Landroid/support/v4/media/session/MediaSessionCompat$a;->onAddQueueItem(Landroid/support/v4/media/MediaDescriptionCompat;)V
    ...
    invoke-virtual {v1, v0, v2}, Landroid/support/v4/media/session/MediaSessionCompat$a;->onAddQueueItem(Landroid/support/v4/media/MediaDescriptionCompat;I)V
    ...
    invoke-virtual {v1, v0}, Landroid/support/v4/media/session/MediaSessionCompat$a;->onRemoveQueueItem(Landroid/support/v4/media/MediaDescriptionCompat;)V
    ...
    invoke-virtual {v1, v0}, Landroid/support/v4/media/session/MediaSessionCompat$a;->onRemoveQueueItemAt(I)V
    ...
    invoke-virtual {v1, v0}, Landroid/support/v4/media/session/MediaSessionCompat$a;->onSetRepeatMode(I)V
    ...
    invoke-virtual {v1, v0}, Landroid/support/v4/media/session/MediaSessionCompat$a;->onSetShuffleModeEnabled(Z)V

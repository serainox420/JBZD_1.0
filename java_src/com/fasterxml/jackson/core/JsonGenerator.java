...
public abstract class JsonGenerator implements Versioned, Closeable, Flushable {
    ...
    public abstract JsonStreamContext mo476getOutputContext();
    ...
    public Object getCurrentValue() {
        JsonStreamContext mo476getOutputContext = mo476getOutputContext();
        if (mo476getOutputContext == null) {
            return null;
        }
        return mo476getOutputContext.getCurrentValue();
    }

    public void setCurrentValue(Object obj) {
        JsonStreamContext mo476getOutputContext = mo476getOutputContext();
        if (mo476getOutputContext != null) {
            mo476getOutputContext.setCurrentValue(obj);
        }
    }

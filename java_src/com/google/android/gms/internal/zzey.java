...
public interface zzey extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzey {
        ...
        /* loaded from: classes2.dex */
        private static class C0331zza implements zzey {
        ...
        public static zzey zzu(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof zzey)) ? new C0331zza(iBinder) : (zzey) queryLocalInterface;
        }

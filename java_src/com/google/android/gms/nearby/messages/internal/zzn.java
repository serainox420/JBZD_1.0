...
public interface zzn extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzn {
        ...
        /* renamed from: com.google.android.gms.nearby.messages.internal.zzn$zza$zza  reason: collision with other inner class name */
        /* loaded from: classes2.dex */
        private static class C0475zza implements zzn {
            private IBinder zzrk;

            C0475zza(IBinder iBinder) {
                this.zzrk = iBinder;
            }
        ...
        public static zzn zzeK(IBinder iBinder) {
            if (iBinder == null) {
                return null;
            }
            IInterface queryLocalInterface = iBinder.queryLocalInterface("com.google.android.gms.nearby.messages.internal.INearbyMessagesCallback");
            return (queryLocalInterface == null || !(queryLocalInterface instanceof zzn)) ? new C0475zza(iBinder) : (zzn) queryLocalInterface;
        }

...
public interface zzack extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzack {
        ...
        /* loaded from: classes2.dex */
        private static class C0200zza implements zzack {
        ...
        public static zzack zzbA(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof zzack)) ? new C0200zza(iBinder) : (zzack) queryLocalInterface;
        }

...
public interface zzka extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzka {
        ...
        /* loaded from: classes2.dex */
        private static class C0355zza implements zzka {
            private IBinder zzrk;

            C0355zza(IBinder iBinder) {
                this.zzrk = iBinder;
            }
        ...
        public static zzka zzM(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof zzka)) ? new C0355zza(iBinder) : (zzka) queryLocalInterface;
        }

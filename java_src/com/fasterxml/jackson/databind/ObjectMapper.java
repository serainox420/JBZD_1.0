...
public class ObjectMapper extends ObjectCodec implements Versioned, Serializable {
    ...
    public /* bridge */ /* synthetic */ Iterator mo230readValues(JsonParser jsonParser, TypeReference typeReference) throws IOException {
        return mo230readValues(jsonParser, (TypeReference<?>) typeReference);
    }
    ...
    public static class DefaultTypeResolverBuilder extends StdTypeResolverBuilder implements Serializable {
        ...
        /* JADX WARN: Removed duplicated region for block: B:13:0x002c A[LOOP:3: B:11:0x0026->B:13:0x002c, LOOP_END] */
        /*
            ...
            switch (this._appliesFor) {
                case NON_CONCRETE_AND_ARRAYS:
                    while (javaType.isArrayType()) {
                        javaType = javaType.mo463getContentType();
                    }
                    while (javaType.isReferenceType()) {
                        javaType = javaType.mo464getReferencedType();
                    }
    ...
    protected ObjectMapper(ObjectMapper objectMapper) {
        ...
        this._mixIns = objectMapper._mixIns.mo353copy();
    ...
    /* JADX WARN: Code restructure failed: missing block: B:10:0x001f, code lost:
        if (r2._registeredModuleTypes.add(r0) == false) goto L10;
     */
    /*
        Code decompiled incorrectly, please refer to instructions dump.
    */
    public ObjectMapper registerModule(Module module) {
        if (isEnabled(MapperFeature.IGNORE_DUPLICATE_MODULE_REGISTRATIONS) && (r0 = module.getTypeId()) != null) {
        ...
        module.setupModule(new Module.SetupContext() { // from class: com.fasterxml.jackson.databind.ObjectMapper.1
            ...
            public void setClassIntrospector(ClassIntrospector classIntrospector) {
                this._deserializationConfig = this._deserializationConfig.mo241with(classIntrospector);
                this._serializationConfig = this._serializationConfig.mo241with(classIntrospector);
            }

            @Override // com.fasterxml.jackson.databind.Module.SetupContext
            public void insertAnnotationIntrospector(AnnotationIntrospector annotationIntrospector) {
                this._deserializationConfig = this._deserializationConfig.mo250withInsertedAnnotationIntrospector(annotationIntrospector);
                this._serializationConfig = this._serializationConfig.mo250withInsertedAnnotationIntrospector(annotationIntrospector);
            }

            @Override // com.fasterxml.jackson.databind.Module.SetupContext
            public void appendAnnotationIntrospector(AnnotationIntrospector annotationIntrospector) {
                this._deserializationConfig = this._deserializationConfig.mo249withAppendedAnnotationIntrospector(annotationIntrospector);
                this._serializationConfig = this._serializationConfig.mo249withAppendedAnnotationIntrospector(annotationIntrospector);
            }
    ...
    public ObjectMapper setVisibility(VisibilityChecker<?> visibilityChecker) {
        this._deserializationConfig = this._deserializationConfig.mo242with(visibilityChecker);
        this._serializationConfig = this._serializationConfig.mo242with(visibilityChecker);
        return this;
    }

    public ObjectMapper setVisibility(PropertyAccessor propertyAccessor, JsonAutoDetect.Visibility visibility) {
        this._deserializationConfig = this._deserializationConfig.mo253withVisibility(propertyAccessor, visibility);
        this._serializationConfig = this._serializationConfig.mo253withVisibility(propertyAccessor, visibility);
        return this;
    }
    ...
    public ObjectMapper setSubtypeResolver(SubtypeResolver subtypeResolver) {
        ...
        this._deserializationConfig = this._deserializationConfig.mo243with(subtypeResolver);
        this._serializationConfig = this._serializationConfig.mo243with(subtypeResolver);
        return this;
    }

    public ObjectMapper setAnnotationIntrospector(AnnotationIntrospector annotationIntrospector) {
        this._serializationConfig = this._serializationConfig.mo237with(annotationIntrospector);
        this._deserializationConfig = this._deserializationConfig.mo237with(annotationIntrospector);
        return this;
    }
    ...
    public ObjectMapper setAnnotationIntrospectors(AnnotationIntrospector annotationIntrospector, AnnotationIntrospector annotationIntrospector2) {
        this._serializationConfig = this._serializationConfig.mo237with(annotationIntrospector);
        this._deserializationConfig = this._deserializationConfig.mo237with(annotationIntrospector2);
        return this;
    }

    public ObjectMapper setPropertyNamingStrategy(PropertyNamingStrategy propertyNamingStrategy) {
        this._serializationConfig = this._serializationConfig.mo238with(propertyNamingStrategy);
        this._deserializationConfig = this._deserializationConfig.mo238with(propertyNamingStrategy);
        return this;
    }
    ...
    public ObjectMapper setDefaultTyping(TypeResolverBuilder<?> typeResolverBuilder) {
        this._deserializationConfig = this._deserializationConfig.mo244with(typeResolverBuilder);
        this._serializationConfig = this._serializationConfig.mo244with(typeResolverBuilder);
        return this;
    }
    ...
    public ObjectMapper setTypeFactory(TypeFactory typeFactory) {
        ...
        this._deserializationConfig = this._deserializationConfig.mo245with(typeFactory);
        this._serializationConfig = this._serializationConfig.mo245with(typeFactory);
        return this;
    }
    ...
    public ObjectMapper setBase64Variant(Base64Variant base64Variant) {
        this._serializationConfig = this._serializationConfig.mo236with(base64Variant);
        this._deserializationConfig = this._deserializationConfig.mo236with(base64Variant);
        return this;
    }
    ...
    public ObjectMapper setDateFormat(DateFormat dateFormat) {
        this._deserializationConfig = this._deserializationConfig.mo246with(dateFormat);
        this._serializationConfig = this._serializationConfig.mo246with(dateFormat);
        return this;
    }
    ...
    public Object setHandlerInstantiator(HandlerInstantiator handlerInstantiator) {
        this._deserializationConfig = this._deserializationConfig.mo240with(handlerInstantiator);
        this._serializationConfig = this._serializationConfig.mo240with(handlerInstantiator);
        return this;
    }
    ...
    public ObjectMapper setLocale(Locale locale) {
        this._deserializationConfig = this._deserializationConfig.mo247with(locale);
        this._serializationConfig = this._serializationConfig.mo247with(locale);
        return this;
    }

    public ObjectMapper setTimeZone(TimeZone timeZone) {
        this._deserializationConfig = this._deserializationConfig.mo248with(timeZone);
        this._serializationConfig = this._serializationConfig.mo248with(timeZone);
        return this;
    }
    ...
    public ObjectMapper configure(MapperFeature mapperFeature, boolean z) {
        this._serializationConfig = z ? this._serializationConfig.mo235with(mapperFeature) : this._serializationConfig.mo254without(mapperFeature);
        this._deserializationConfig = z ? this._deserializationConfig.mo235with(mapperFeature) : this._deserializationConfig.mo254without(mapperFeature);
        return this;
    }

    public ObjectMapper enable(MapperFeature... mapperFeatureArr) {
        this._deserializationConfig = this._deserializationConfig.mo235with(mapperFeatureArr);
        this._serializationConfig = this._serializationConfig.mo235with(mapperFeatureArr);
        return this;
    }

    public ObjectMapper disable(MapperFeature... mapperFeatureArr) {
        this._deserializationConfig = this._deserializationConfig.mo254without(mapperFeatureArr);
        this._serializationConfig = this._serializationConfig.mo254without(mapperFeatureArr);
        return this;
    }
    ...
    public <T extends TreeNode> T readTree(JsonParser jsonParser) throws IOException, JsonProcessingException {
        ...
        if (jsonNode == null) {
            return getNodeFactory().mo394nullNode();
        }
        return jsonNode;
    }
    ...
    public <T> MappingIterator<T> mo229readValues(JsonParser jsonParser, ResolvedType resolvedType) throws IOException, JsonProcessingException {
    ...
    @Override // com.fasterxml.jackson.core.ObjectCodec
    /* renamed from: readValues */
    public <T> MappingIterator<T> mo231readValues(JsonParser jsonParser, Class<T> cls) throws IOException, JsonProcessingException {
        return readValues(jsonParser, this._typeFactory.constructType(cls));
    }

    @Override // com.fasterxml.jackson.core.ObjectCodec
    /* renamed from: readValues */
    public <T> MappingIterator<T> mo230readValues(JsonParser jsonParser, TypeReference<?> typeReference) throws IOException, JsonProcessingException {
    ...
    public ObjectWriter writer(DateFormat dateFormat) {
        return _newWriter(getSerializationConfig().mo246with(dateFormat));
    }

    public ObjectWriter writerWithView(Class<?> cls) {
        return _newWriter(getSerializationConfig().mo252withView(cls));
    }
    ...
    public ObjectWriter writer(Base64Variant base64Variant) {
        return _newWriter(getSerializationConfig().mo236with(base64Variant));
    }
    ...
    public ObjectWriter writer(ContextAttributes contextAttributes) {
        return _newWriter(getSerializationConfig().mo239with(contextAttributes));
    }
    ...
    public ObjectReader readerWithView(Class<?> cls) {
        return _newReader(getDeserializationConfig().mo252withView(cls));
    }

    public ObjectReader reader(Base64Variant base64Variant) {
        return _newReader(getDeserializationConfig().mo236with(base64Variant));
    }

    public ObjectReader reader(ContextAttributes contextAttributes) {
        return _newReader(getDeserializationConfig().mo239with(contextAttributes));
    }
        ...
        if (rawClass == Object.class || javaType.hasGenericTypes() || !rawClass.isAssignableFrom(obj.getClass())) {
            ...
            try {
                ...
                if (_initForReading == JsonToken.VALUE_NULL) {
                    ...
                    obj = _findRootDeserializer(createDeserializationContext, javaType).mo289getNullValue(createDeserializationContext);
                    ...
                    obj = _findRootDeserializer(createDeserializationContext2, javaType).mo573deserialize(asParser, createDeserializationContext2);
                }
                asParser.close();
            } catch (IOException e) {
                throw new IllegalArgumentException(e.getMessage(), e);
    ...
    protected DefaultSerializerProvider _serializerProvider(SerializationConfig serializationConfig) {
        return this._serializerProvider.mo420createInstance(serializationConfig, this._serializerFactory);
    }
    ...
    protected Object _readValue(DeserializationConfig deserializationConfig, JsonParser jsonParser, JavaType javaType) throws IOException {
        ...
        if (_initForReading == JsonToken.VALUE_NULL) {
            ...
            if (deserializationConfig.useRootWrapping()) {
                ...
                obj = _findRootDeserializer.mo573deserialize(jsonParser, createDeserializationContext2);
            }
        }
    ...
    protected Object _unwrapAndDeserialize(JsonParser jsonParser, DeserializationContext deserializationContext, DeserializationConfig deserializationConfig, JavaType javaType, JsonDeserializer<Object> jsonDeserializer) throws IOException {
        ...
        Object mo573deserialize = jsonDeserializer.mo573deserialize(jsonParser, deserializationContext);

...
public class Media extends u implements f, BaseFeedModel {
    public static final Parcelable.Creator CREATOR = new Parcelable.Creator() { // from class: pl.jbzd.app.model.Media.1
    ...
    public String toString() {
        return ApiUtils.toString(this, Media.class);
    }

    public static Media fromBaseMedia(BaseMedia baseMedia) {
        Media media = new Media(baseMedia.realmGet$type(), baseMedia.realmGet$width(), baseMedia.realmGet$height());
        media.realmSet$id(baseMedia.realmGet$id());
        media.realmSet$user_id(baseMedia.realmGet$user_id());
        media.realmSet$image(baseMedia.realmGet$image());
        media.realmSet$pictures_counter(baseMedia.realmGet$pictures_counter());
        media.realmSet$media_added(baseMedia.realmGet$media_added());
        media.realmSet$title(baseMedia.realmGet$title());
        media.realmSet$url(baseMedia.realmGet$url());
        media.realmSet$vote_score(baseMedia.realmGet$vote_score());
        media.realmSet$comments_counter(baseMedia.realmGet$comments() != null ? baseMedia.realmGet$comments().size() : 0);
        media.realmSet$date(baseMedia.realmGet$date());
        media.realmSet$share_image(baseMedia.realmGet$share_image());
        media.realmSet$share_url(baseMedia.realmGet$share_url());
        return media;
    }
    ...
    @JsonCreator
    public Media(@JsonProperty("media_type") String str, @JsonProperty("media_image_width") int i, @JsonProperty("media_image_height") int i2) {
        if (this instanceof l) {
            ((l) this).a();
        }
        realmSet$voted(0);
    ...
    public Media(int i, int i2, boolean z) {
        if (this instanceof l) {
            ((l) this).a();
        }
        realmSet$voted(0);
    ...
    public int getComments_counter() {
        return realmGet$comments_counter();
    }

    public void setComments_counter(int i) {
        realmSet$comments_counter(i);
    }
    ...
    public Media(Parcel parcel) {
        ...
        realmSet$comments_counter(parcel.readInt());
    ...
    public void writeToParcel(Parcel parcel, int i) {
        ...
        parcel.writeInt(realmGet$comments_counter());

...
public interface zzhq extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzhq {
        ...
        /* loaded from: classes2.dex */
        private static class C0345zza implements zzhq {
            private IBinder zzrk;

            C0345zza(IBinder iBinder) {
                this.zzrk = iBinder;
            }
        ...
        public static zzhq zzI(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof zzhq)) ? new C0345zza(iBinder) : (zzhq) queryLocalInterface;
        }
    ...
    void zza(zzhl zzhlVar) throws RemoteException;
}

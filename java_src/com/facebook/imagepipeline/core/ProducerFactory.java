...
public class ProducerFactory {
    ...
    public ProducerFactory(Context context, ByteArrayPool byteArrayPool, ImageDecoder imageDecoder, ProgressiveJpegConfig progressiveJpegConfig, boolean z, boolean z2, boolean z3, ExecutorSupplier executorSupplier, PooledByteBufferFactory pooledByteBufferFactory, MemoryCache<CacheKey, CloseableImage> memoryCache, MemoryCache<CacheKey, PooledByteBuffer> memoryCache2, BufferedDiskCache bufferedDiskCache, BufferedDiskCache bufferedDiskCache2, MediaVariationsIndex mediaVariationsIndex, @Nullable MediaIdExtractor mediaIdExtractor, CacheKeyFactory cacheKeyFactory, PlatformBitmapFactory platformBitmapFactory, int i) {
        ...
        if (i > 0) {
            this.mMainDiskCachePolicy = new SplitCachesByImageSizeDiskCachePolicy(bufferedDiskCache, bufferedDiskCache2, cacheKeyFactory, i);
        } else {
            this.mMainDiskCachePolicy = new SmallCacheIfRequestedDiskCachePolicy(bufferedDiskCache, bufferedDiskCache2, cacheKeyFactory);
        }
    }
    ...
    public DiskCacheReadProducer newDiskCacheReadProducer(Producer<EncodedImage> producer) {
        return new DiskCacheReadProducer(producer, this.mMainDiskCachePolicy);
    }

    public DiskCacheWriteProducer newDiskCacheWriteProducer(Producer<EncodedImage> producer) {
        return new DiskCacheWriteProducer(producer, this.mMainDiskCachePolicy);
    }

    public MediaVariationsFallbackProducer newMediaVariationsProducer(Producer<EncodedImage> producer) {
        return new MediaVariationsFallbackProducer(this.mDefaultBufferedDiskCache, this.mSmallImageBufferedDiskCache, this.mCacheKeyFactory, this.mMediaVariationsIndex, this.mMediaIdExtractor, this.mMainDiskCachePolicy, producer);
    }

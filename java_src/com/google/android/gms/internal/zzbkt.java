...
public interface zzbkt extends IInterface {
    ...
    /* loaded from: classes2.dex */
    public static abstract class zza extends Binder implements zzbkt {

        /* renamed from: com.google.android.gms.internal.zzbkt$zza$zza  reason: collision with other inner class name */
        /* loaded from: classes2.dex */
        private static class C0298zza implements zzbkt {
            private IBinder zzrk;

            C0298zza(IBinder iBinder) {
                this.zzrk = iBinder;
            }
        ...
        public static zzbkt zzfu(IBinder iBinder) {
            if (iBinder == null) {
                return null;
            }
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof zzbkt)) ? new C0298zza(iBinder) : (zzbkt) queryLocalInterface;
        }

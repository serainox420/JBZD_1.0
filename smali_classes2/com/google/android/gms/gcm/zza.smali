...
.method private zzH(Landroid/os/Bundle;)Landroid/app/Notification;
    ...
    new-instance v6, Landroid/support/v4/app/aj$d;

    iget-object v7, p0, Lcom/google/android/gms/gcm/zza;->mContext:Landroid/content/Context;

    invoke-direct {v6, v7}, Landroid/support/v4/app/aj$d;-><init>(Landroid/content/Context;)V

    const/4 v7, 0x1

    invoke-virtual {v6, v7}, Landroid/support/v4/app/aj$d;->c(Z)Landroid/support/v4/app/aj$d;

    move-result-object v6

    invoke-virtual {v6, v2}, Landroid/support/v4/app/aj$d;->a(I)Landroid/support/v4/app/aj$d;
    ...
    invoke-virtual {v2, v0}, Landroid/support/v4/app/aj$d;->c(I)Landroid/support/v4/app/aj$d;

    :cond_1
    if-eqz v4, :cond_2

    invoke-virtual {v2, v4}, Landroid/support/v4/app/aj$d;->a(Landroid/net/Uri;)Landroid/support/v4/app/aj$d;

    :cond_2
    if-eqz v5, :cond_3

    invoke-virtual {v2, v5}, Landroid/support/v4/app/aj$d;->a(Landroid/app/PendingIntent;)Landroid/support/v4/app/aj$d;
...
.method static declared-synchronized zzbt(Landroid/content/Context;)Lcom/google/android/gms/gcm/zza;
    ...
    :try_start_0
    sget-object v0, Lcom/google/android/gms/gcm/zza;->zzbgn:Lcom/google/android/gms/gcm/zza;

...
public interface zzla extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzla {
        ...
        /* loaded from: classes2.dex */
        private static class C0362zza implements zzla {
            private IBinder zzrk;

            C0362zza(IBinder iBinder) {
                this.zzrk = iBinder;
            }
        ...
        public static zzla zzU(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof zzla)) ? new C0362zza(iBinder) : (zzla) queryLocalInterface;
        }

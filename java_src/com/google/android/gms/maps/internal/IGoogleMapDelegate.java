...
public interface IGoogleMapDelegate extends IInterface {
    ...
    public static abstract class zza extends Binder implements IGoogleMapDelegate {
        ...
        /* loaded from: classes2.dex */
        public static class C0422zza implements IGoogleMapDelegate {
            private IBinder zzrk;

            C0422zza(IBinder iBinder) {
                this.zzrk = iBinder;
            }
        ...
        public static IGoogleMapDelegate zzdu(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof IGoogleMapDelegate)) ? new C0422zza(iBinder) : (IGoogleMapDelegate) queryLocalInterface;
        }

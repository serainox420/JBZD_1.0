...
public abstract class SerializerProvider extends DatabindContext {
    ...
    public final SerializationConfig mo255getConfig() {
        return this._config;
    }
    ...
    public SerializerProvider mo256setAttribute(Object obj, Object obj2) {
    ...
    public JsonSerializer<Object> findTypedValueSerializer(Class<?> cls, boolean z, BeanProperty beanProperty) throws JsonMappingException {
        ...
        if (typedValueSerializer == null && (typedValueSerializer = this._serializerCache.typedValueSerializer(cls)) == null) {
            ...
            typedValueSerializer = createTypeSerializer != null ? new TypeWrappedSerializer(createTypeSerializer.mo368forProperty(beanProperty), findValueSerializer) : findValueSerializer;
            if (z) {

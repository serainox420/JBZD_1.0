...
public class TokenBuffer extends JsonGenerator {
    ...
    public final JsonWriteContext mo476getOutputContext() {
    ...
    public final void writeEndArray() throws IOException {
        ...
        JsonWriteContext mo404getParent = this._writeContext.mo404getParent();
        if (mo404getParent != null) {
            this._writeContext = mo404getParent;
        }
    }
    ...
    public static final class Parser extends ParserMinimalBase {
        ...
        public JsonToken nextToken() throws IOException {
            ...
            if (this._currToken == JsonToken.FIELD_NAME) {
                ...
                this._parsingContext = this._parsingContext.mo404getParent();
        ...
        public String getCurrentName() {
            return (this._currToken == JsonToken.START_OBJECT || this._currToken == JsonToken.START_ARRAY) ? this._parsingContext.mo404getParent().getCurrentName() : this._parsingContext.getCurrentName();
        }

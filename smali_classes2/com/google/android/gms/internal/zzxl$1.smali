...
.method public onClick(Landroid/view/View;)V
    ...
    invoke-static {v0}, Lcom/google/android/gms/internal/zzxl;->zza(Lcom/google/android/gms/internal/zzxl;)Ljava/lang/ref/WeakReference;
    ...
    :cond_1
    iget-object v1, p0, Lcom/google/android/gms/internal/zzxl$1;->zzatB:Lcom/google/android/gms/internal/zzxl;

    invoke-static {v1}, Lcom/google/android/gms/internal/zzxl;->zzb(Lcom/google/android/gms/internal/zzxl;)Lcom/google/android/gms/cast/framework/media/RemoteMediaClient;
    ...
    invoke-virtual {v2}, Landroid/support/v4/app/u;->a()Landroid/support/v4/app/y;
    ...
    invoke-virtual {v0, v3}, Landroid/support/v4/app/u;->a(Ljava/lang/String;)Landroid/support/v4/app/Fragment;

    move-result-object v0

    if-eqz v0, :cond_2

    invoke-virtual {v2, v0}, Landroid/support/v4/app/y;->a(Landroid/support/v4/app/Fragment;)Landroid/support/v4/app/y;

    :cond_2
    const/4 v0, 0x0

    invoke-virtual {v2, v0}, Landroid/support/v4/app/y;->a(Ljava/lang/String;)Landroid/support/v4/app/y;
    ...
    invoke-virtual {v0, v2, v1}, Lcom/google/android/gms/cast/framework/media/TracksChooserDialogFragment;->show(Landroid/support/v4/app/y;Ljava/lang/String;)I

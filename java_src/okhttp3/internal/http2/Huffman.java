...
class Huffman {
    ...
    public int encodedLength(ByteString byteString) {
        ...
        for (int i = 0; i < byteString.size(); i++) {
            j += CODE_LENGTHS[byteString.getByte(i) & Constants.UNKNOWN];
        }
        return (int) ((7 + j) >> 3);
    }

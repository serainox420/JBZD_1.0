...
public interface zzez extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzez {
        ...
        /* loaded from: classes2.dex */
        private static class C0332zza implements zzez {
            private IBinder zzrk;

            C0332zza(IBinder iBinder) {
                this.zzrk = iBinder;
            }
        ...
        public static zzez zzv(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof zzez)) ? new C0332zza(iBinder) : (zzez) queryLocalInterface;
        }

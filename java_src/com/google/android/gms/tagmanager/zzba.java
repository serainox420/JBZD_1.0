...
public interface zzba extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzba {
        ...
        /* renamed from: com.google.android.gms.tagmanager.zzba$zza$zza  reason: collision with other inner class name */
        /* loaded from: classes2.dex */
        private static class C0488zza implements zzba {
            private IBinder zzrk;

            C0488zza(IBinder iBinder) {
                this.zzrk = iBinder;
            }
        ...
        public static zzba zzfj(IBinder iBinder) {
            if (iBinder == null) {
                return null;
            }
            IInterface queryLocalInterface = iBinder.queryLocalInterface("com.google.android.gms.tagmanager.IMeasurementInterceptor");
            return (queryLocalInterface == null || !(queryLocalInterface instanceof zzba)) ? new C0488zza(iBinder) : (zzba) queryLocalInterface;
        }

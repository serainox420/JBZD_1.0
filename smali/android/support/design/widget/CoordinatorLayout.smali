...
.field private static final f:Landroid/support/v4/f/j$a;
    .annotation system Ldalvik/annotation/Signature;
        value = {
...
.field private u:Landroid/support/v4/view/bg;

.field private v:Z

.field private w:Landroid/graphics/drawable/Drawable;

.field private x:Landroid/support/v4/view/z;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Landroid/support/design/widget/CoordinatorLayout;->f:Landroid/support/v4/f/j$a;
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    invoke-direct {v1, p0}, Landroid/support/v4/view/y;-><init>(Landroid/view/ViewGroup;)V

    iput-object v1, p0, Landroid/support/design/widget/CoordinatorLayout;->y:Landroid/support/v4/view/y;
...
.method private static a(Landroid/graphics/Rect;)V
    ...
    .line 161
    sget-object v0, Landroid/support/design/widget/CoordinatorLayout;->f:Landroid/support/v4/f/j$a;
...
.method private a(Landroid/view/View;ILandroid/graphics/Rect;Landroid/graphics/Rect;Landroid/support/design/widget/CoordinatorLayout$c;II)V
    ...
    .line 944
    invoke-static {v0, p2}, Landroid/support/v4/view/f;->a(II)I
...
.method private a(Landroid/view/View;Landroid/graphics/Rect;I)V
    ...
    invoke-static {v2, p3}, Landroid/support/v4/view/f;->a(II)I
...
.method private b(Landroid/support/v4/view/bg;)Landroid/support/v4/view/bg;
    .locals 5

    .prologue
    .line 807
    invoke-virtual {p1}, Landroid/support/v4/view/bg;->f()Z
    ...
    .line 820
    invoke-virtual {v0}, Landroid/support/v4/view/bg;->f()Z
...
.method private c(Landroid/view/View;I)V
    ...
    .line 1154
    iget-object v1, p0, Landroid/support/design/widget/CoordinatorLayout;->u:Landroid/support/v4/view/bg;
    ...
    iget-object v2, p0, Landroid/support/design/widget/CoordinatorLayout;->u:Landroid/support/v4/view/bg;
...
.method private h()V
    ...
    .line 3048
    iget-object v0, p0, Landroid/support/design/widget/CoordinatorLayout;->x:Landroid/support/v4/view/z;
    ...
    iput-object v0, p0, Landroid/support/design/widget/CoordinatorLayout;->x:Landroid/support/v4/view/z;

    .line 3059
    :cond_1
    iget-object v0, p0, Landroid/support/design/widget/CoordinatorLayout;->x:Landroid/support/v4/view/z;

    invoke-static {p0, v0}, Landroid/support/v4/view/ai;->a(Landroid/view/View;Landroid/support/v4/view/z;)V
...
.method final a(Landroid/support/v4/view/bg;)Landroid/support/v4/view/bg;
    .locals 3
    ...
    .line 354
    iget-object v0, p0, Landroid/support/design/widget/CoordinatorLayout;->u:Landroid/support/v4/view/bg;
    ...
    .line 355
    iput-object p1, p0, Landroid/support/design/widget/CoordinatorLayout;->u:Landroid/support/v4/view/bg;
    ...
    .line 360
    invoke-direct {p0, p1}, Landroid/support/design/widget/CoordinatorLayout;->b(Landroid/support/v4/view/bg;)Landroid/support/v4/view/bg;
...
.method final a(I)V
    ...
    invoke-static {v2, v7}, Landroid/support/v4/view/f;->a(II)I
...
.method a(Landroid/view/View;Landroid/graphics/Rect;)V
    ...
    .prologue
    .line 686
    invoke-static {p0, p1, p2}, Landroid/support/design/widget/u;->b(Landroid/view/ViewGroup;Landroid/view/View;Landroid/graphics/Rect;)V
...
.method final getLastWindowInsets()Landroid/support/v4/view/bg;
    .locals 1
...
.method public getNestedScrollAxes()I
    ...
    .prologue
    .line 1901
    iget-object v0, p0, Landroid/support/design/widget/CoordinatorLayout;->y:Landroid/support/v4/view/y;
...
.method protected onMeasure(II)V
    ...
    iget-object v1, v0, Landroid/support/design/widget/CoordinatorLayout;->u:Landroid/support/v4/view/bg;
    ...
    iget-object v2, v0, Landroid/support/design/widget/CoordinatorLayout;->u:Landroid/support/v4/view/bg;
    ...
    iget-object v4, v0, Landroid/support/design/widget/CoordinatorLayout;->u:Landroid/support/v4/view/bg;

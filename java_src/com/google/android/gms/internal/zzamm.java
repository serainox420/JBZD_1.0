...
public interface zzamm extends IInterface {

    /* loaded from: classes2.dex */
    public static abstract class zza extends Binder implements zzamm {

        /* renamed from: com.google.android.gms.internal.zzamm$zza$zza  reason: collision with other inner class name */
        /* loaded from: classes2.dex */
        private static class C0223zza implements zzamm {
        ...
        public static zzamm zzbY(IBinder iBinder) {
            if (iBinder == null) {
                return null;
            }
            IInterface queryLocalInterface = iBinder.queryLocalInterface("com.google.android.gms.drive.realtime.internal.IIntCallback");
            return (queryLocalInterface == null || !(queryLocalInterface instanceof zzamm)) ? new C0223zza(iBinder) : (zzamm) queryLocalInterface;
        }

...
public interface zzhn extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzhn {
        ...
        /* loaded from: classes2.dex */
        private static class C0343zza implements zzhn {
            private IBinder zzrk;

            C0343zza(IBinder iBinder) {
                this.zzrk = iBinder;
            }
        ...
        public static zzhn zzG(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof zzhn)) ? new C0343zza(iBinder) : (zzhn) queryLocalInterface;
        }

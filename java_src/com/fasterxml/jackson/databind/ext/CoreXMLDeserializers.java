...
public class CoreXMLDeserializers extends Deserializers.Base {
    ...
    public static class Std extends FromStringDeserializer<Object> {
        ...
        public Object mo573deserialize(JsonParser jsonParser, DeserializationContext deserializationContext) throws IOException {
            return (this._kind != 2 || !jsonParser.hasToken(JsonToken.VALUE_NUMBER_INT)) ? super.mo573deserialize(jsonParser, deserializationContext) : _gregorianFromDate(deserializationContext, _parseDate(jsonParser, deserializationContext));
        }

        /* JADX INFO: Access modifiers changed from: protected */
        @Override // com.fasterxml.jackson.databind.deser.std.FromStringDeserializer
        /* renamed from: _deserialize */
        public Object mo324_deserialize(String str, DeserializationContext deserializationContext) throws IOException {
            switch (this._kind) {
                case 1:

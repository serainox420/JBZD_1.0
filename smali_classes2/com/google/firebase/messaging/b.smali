.class Lcom/google/firebase/messaging/b;
.super Ljava/lang/Object;


# static fields
.field static a:Lcom/google/firebase/messaging/b;
...
.method private constructor <init>(Landroid/content/Context;)V
    ...
    iput-object v0, p0, Lcom/google/firebase/messaging/b;->d:Ljava/util/concurrent/atomic/AtomicInteger;
...
.method private a(Landroid/os/Bundle;Landroid/app/PendingIntent;)Landroid/app/PendingIntent;
    ...
    invoke-direct {p0, v0, p1}, Lcom/google/firebase/messaging/b;->a(Landroid/content/Intent;Landroid/os/Bundle;)V
    ...
    invoke-direct {p0}, Lcom/google/firebase/messaging/b;->b()I

    move-result v2

    const/high16 v3, 0x40000000    # 2.0f

    invoke-static {v1, v2, v0, v3}, Lcom/google/firebase/iid/f;->b(Landroid/content/Context;ILandroid/content/Intent;I)Landroid/app/PendingIntent;
...
.method private b()I
    ...
    iget-object v0, p0, Lcom/google/firebase/messaging/b;->d:Ljava/util/concurrent/atomic/AtomicInteger;
...
.method private b(Ljava/lang/String;)I
    ...
    :cond_2
    invoke-direct {p0}, Lcom/google/firebase/messaging/b;->c()Landroid/os/Bundle;
...
.method static c(Landroid/os/Bundle;Ljava/lang/String;)[Ljava/lang/Object;
    ...
    :goto_3
    invoke-static {v0}, Lcom/google/firebase/messaging/b;->a(Ljava/lang/String;)Ljava/lang/String;
...
.method private e(Landroid/os/Bundle;)Landroid/app/Notification;
    ...
    invoke-direct {p0, v0}, Lcom/google/firebase/messaging/b;->b(Ljava/lang/String;)I
    ...
    invoke-direct {p0, v0}, Lcom/google/firebase/messaging/b;->c(Ljava/lang/String;)Ljava/lang/Integer;
    ...
    invoke-direct {p0, v0}, Lcom/google/firebase/messaging/b;->d(Ljava/lang/String;)Landroid/net/Uri;

    move-result-object v6

    invoke-direct {p0, p1}, Lcom/google/firebase/messaging/b;->f(Landroid/os/Bundle;)Landroid/app/PendingIntent;
    ...
    invoke-direct {p0, p1, v1}, Lcom/google/firebase/messaging/b;->a(Landroid/os/Bundle;Landroid/app/PendingIntent;)Landroid/app/PendingIntent;

    move-result-object v1

    invoke-direct {p0, p1}, Lcom/google/firebase/messaging/b;->h(Landroid/os/Bundle;)Landroid/app/PendingIntent;

    move-result-object v0

    :cond_0
    new-instance v7, Landroid/support/v4/app/aj$d;

    iget-object v8, p0, Lcom/google/firebase/messaging/b;->b:Landroid/content/Context;

    invoke-direct {v7, v8}, Landroid/support/v4/app/aj$d;-><init>(Landroid/content/Context;)V

    const/4 v8, 0x1

    invoke-virtual {v7, v8}, Landroid/support/v4/app/aj$d;->c(Z)Landroid/support/v4/app/aj$d;

    move-result-object v7

    invoke-virtual {v7, v4}, Landroid/support/v4/app/aj$d;->a(I)Landroid/support/v4/app/aj$d;
    ...
    invoke-virtual {v4, v2}, Landroid/support/v4/app/aj$d;->a(Ljava/lang/CharSequence;)Landroid/support/v4/app/aj$d;
    ...
    invoke-virtual {v4, v3}, Landroid/support/v4/app/aj$d;->b(Ljava/lang/CharSequence;)Landroid/support/v4/app/aj$d;

    new-instance v2, Landroid/support/v4/app/aj$c;

    invoke-direct {v2}, Landroid/support/v4/app/aj$c;-><init>()V

    invoke-virtual {v2, v3}, Landroid/support/v4/app/aj$c;->a(Ljava/lang/CharSequence;)Landroid/support/v4/app/aj$c;

    move-result-object v2

    invoke-virtual {v4, v2}, Landroid/support/v4/app/aj$d;->a(Landroid/support/v4/app/aj$q;)Landroid/support/v4/app/aj$d;
    ...
    invoke-virtual {v4, v2}, Landroid/support/v4/app/aj$d;->c(I)Landroid/support/v4/app/aj$d;

    :cond_2
    if-eqz v6, :cond_3

    invoke-virtual {v4, v6}, Landroid/support/v4/app/aj$d;->a(Landroid/net/Uri;)Landroid/support/v4/app/aj$d;

    :cond_3
    if-eqz v1, :cond_4

    invoke-virtual {v4, v1}, Landroid/support/v4/app/aj$d;->a(Landroid/app/PendingIntent;)Landroid/support/v4/app/aj$d;

    :cond_4
    if-eqz v0, :cond_5

    invoke-virtual {v4, v0}, Landroid/support/v4/app/aj$d;->b(Landroid/app/PendingIntent;)Landroid/support/v4/app/aj$d;

    :cond_5
    invoke-virtual {v4}, Landroid/support/v4/app/aj$d;->a()Landroid/app/Notification;
...
.method private f(Landroid/os/Bundle;)Landroid/app/PendingIntent;
    ...
    invoke-direct {p0, p1}, Lcom/google/firebase/messaging/b;->g(Landroid/os/Bundle;)Landroid/content/Intent;
    ...
    invoke-static {v0}, Lcom/google/firebase/messaging/FirebaseMessagingService;->zzD(Landroid/os/Bundle;)V
...
.method c(Landroid/os/Bundle;)Z
    ...
    invoke-static {p1, v2}, Lcom/google/firebase/messaging/b;->a(Landroid/os/Bundle;Ljava/lang/String;)Ljava/lang/String;
    ...
    :cond_0
    invoke-direct {p0}, Lcom/google/firebase/messaging/b;->a()Z
    ...
    :cond_1
    invoke-direct {p0, p1}, Lcom/google/firebase/messaging/b;->e(Landroid/os/Bundle;)Landroid/app/Notification;
    ...
    invoke-direct {p0, v2, v1}, Lcom/google/firebase/messaging/b;->a(Ljava/lang/String;Landroid/app/Notification;)V

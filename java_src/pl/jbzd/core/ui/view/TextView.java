...
public class TextView extends android.widget.TextView {
    ...
    public enum Font {
        ...
        private static final Map<Integer, Font> f6114a = new HashMap();
        public int id;
        public String src;
        ...
        static {
            ...
            for (Font font : values()) {
                if (f6114a.put(Integer.valueOf(font.id), font) != null) {
        ...
        public static Font getById(int i) {
            return f6114a.containsKey(Integer.valueOf(i)) ? f6114a.get(Integer.valueOf(i)) : f6114a.get(5);
        }
    }

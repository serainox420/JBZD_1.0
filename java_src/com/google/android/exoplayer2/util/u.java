...
public final class u {
    ...
    public static String b(String str, String str2) {
        ...
        int[] a3 = a(str);
        if (a2[3] == 0) {
            return sb.append((CharSequence) str, 0, a3[3]).append(str2).toString();
        }
        if (a2[2] == 0) {
            return sb.append((CharSequence) str, 0, a3[2]).append(str2).toString();
        }
        if (a2[1] != 0) {
            int i = a3[0] + 1;
            ...
            sb.append((CharSequence) str, 0, a3[1]).append(str2);
            return a(sb, a3[1], a2[2] + a3[1]);
        } else if (a3[0] + 2 < a3[1] && a3[1] == a3[2]) {
            sb.append((CharSequence) str, 0, a3[1]).append('/').append(str2);
            return a(sb, a3[1], a2[2] + a3[1] + 1);
        } else {

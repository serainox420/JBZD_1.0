...
public interface zzke extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzke {
        ...
        /* loaded from: classes2.dex */
        public static class C0359zza implements zzke {
            private IBinder zzrk;

            C0359zza(IBinder iBinder) {
                this.zzrk = iBinder;
            }
        ...
        public static zzke zzQ(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof zzke)) ? new C0359zza(iBinder) : (zzke) queryLocalInterface;
        }

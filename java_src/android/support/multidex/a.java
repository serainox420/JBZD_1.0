...
public final class a {
    ...
    private static final String f158a = "code_cache" + File.separator + "secondary-dexes";
                    ...
                    synchronized (b) {
                        ...
                        if (!b.contains(str)) {
                            ...
                            try {
                                ...
                                File file = new File(b2.dataDir, f158a);
                                List<File> a2 = android.support.multidex.b.a(context, b2, file, false);
                                if (a(a2)) {
                                    a(classLoader, file, a2);
                                } else {
                                    Log.w("MultiDex", "Files were not valid zip files.  Forcing a reload.");
                                    List<File> a3 = android.support.multidex.b.a(context, b2, file, true);
                                    if (a(a3)) {
    ...
    private static boolean a(List<File> list) {
        for (File file : list) {
            if (!android.support.multidex.b.a(file)) {
                return false;
            }
        }
        return true;

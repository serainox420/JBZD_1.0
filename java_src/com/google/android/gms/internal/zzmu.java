...
public interface zzmu extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzmu {
        ...
        /* loaded from: classes2.dex */
        private static class C0372zza implements zzmu {
            private IBinder zzrk;

            C0372zza(IBinder iBinder) {
                this.zzrk = iBinder;
            }
            ...
            public void zza(zzmn zzmnVar) throws RemoteException {
                ...
                try {
                    ...
                    if (zzmnVar != null) {
                        obtain.writeInt(1);
                        zzmnVar.writeToParcel(obtain, 0);
                    } else {
                        obtain.writeInt(0);
                    }
        ...
        public static zzmu zzaf(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof zzmu)) ? new C0372zza(iBinder) : (zzmu) queryLocalInterface;
        }
    ...
    void zza(zzmn zzmnVar) throws RemoteException;
}

...
public interface zzawj extends IInterface {
    ...
    /* loaded from: classes2.dex */
    public static abstract class zza extends Binder implements zzawj {

        /* renamed from: com.google.android.gms.internal.zzawj$zza$zza  reason: collision with other inner class name */
        /* loaded from: classes2.dex */
        private static class C0276zza implements zzawj {
            ...
            @Override // com.google.android.gms.internal.zzawj
            ...
            public void zza(String str, int i, byte[] bArr) throws RemoteException {
                ...
                try {
                    ...
                    obtain.writeInt(i);
                    obtain.writeByteArray(bArr);
                    this.zzrk.transact(Place.TYPE_FLOOR, obtain, obtain2, 0);
                    obtain2.readException();
                } finally {
                    obtain2.recycle();
                    obtain.recycle();
            ...
            @Override // com.google.android.gms.internal.zzawj
            public void zza(String str, String str2, String str3, byte[] bArr) throws RemoteException {
                Parcel obtain = Parcel.obtain();
                Parcel obtain2 = Parcel.obtain();
                try {
                    obtain.writeInterfaceToken("com.google.android.gms.nearby.internal.connection.INearbyConnectionCallbacks");
            ...
            @Override // com.google.android.gms.internal.zzawj
            public void zzb(String str, String str2, String str3, String str4) throws RemoteException {
                Parcel obtain = Parcel.obtain();
                Parcel obtain2 = Parcel.obtain();
                try {
                    obtain.writeInterfaceToken("com.google.android.gms.nearby.internal.connection.INearbyConnectionCallbacks");
            ...
            @Override // com.google.android.gms.internal.zzawj
            public void zzlY(int i) throws RemoteException {
                Parcel obtain = Parcel.obtain();
                Parcel obtain2 = Parcel.obtain();
                try {
                    obtain.writeInterfaceToken("com.google.android.gms.nearby.internal.connection.INearbyConnectionCallbacks");
            ...
            @Override // com.google.android.gms.internal.zzawj
            public void zzlZ(int i) throws RemoteException {
                Parcel obtain = Parcel.obtain();
                Parcel obtain2 = Parcel.obtain();
                try {
                    obtain.writeInterfaceToken("com.google.android.gms.nearby.internal.connection.INearbyConnectionCallbacks");
            ...
            @Override // com.google.android.gms.internal.zzawj
            public void zzma(int i) throws RemoteException {
                Parcel obtain = Parcel.obtain();
                Parcel obtain2 = Parcel.obtain();
                try {
                    obtain.writeInterfaceToken("com.google.android.gms.nearby.internal.connection.INearbyConnectionCallbacks");
            ...
            @Override // com.google.android.gms.internal.zzawj
            public void zzmb(int i) throws RemoteException {
                Parcel obtain = Parcel.obtain();
                Parcel obtain2 = Parcel.obtain();
                try {
                    obtain.writeInterfaceToken("com.google.android.gms.nearby.internal.connection.INearbyConnectionCallbacks");
        ...
        public static zzawj zzeF(IBinder iBinder) {
            if (iBinder == null) {
                return null;
            }
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof zzawj)) ? new C0276zza(iBinder) : (zzawj) queryLocalInterface;
        }
        ...
        public boolean onTransact(int i, Parcel parcel, Parcel parcel2, int i2) throws RemoteException {
            switch (i) {
                case 1001:
                    ...
                    zza(parcel.readString(), parcel.readString(), parcel.readString(), parcel.createByteArray());
                    parcel2.writeNoException();
                    return true;
                case 1002:
                    parcel.enforceInterface("com.google.android.gms.nearby.internal.connection.INearbyConnectionCallbacks");
                    zzb(parcel.readString(), parcel.readString(), parcel.readString(), parcel.readString());
                    parcel2.writeNoException();
                    return true;
                case 1003:
                    parcel.enforceInterface("com.google.android.gms.nearby.internal.connection.INearbyConnectionCallbacks");
    ...
    void zza(String str, String str2, String str3, byte[] bArr) throws RemoteException;

    void zzb(String str, String str2, String str3, String str4) throws RemoteException;

    void zzlY(int i) throws RemoteException;

    void zzlZ(int i) throws RemoteException;

    void zzma(int i) throws RemoteException;

    void zzmb(int i) throws RemoteException;

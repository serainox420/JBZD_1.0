...
public interface zzb extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzb {
        ...
        /* loaded from: classes2.dex */
        public static class C0466zza implements zzb {
            private IBinder zzrk;

            C0466zza(IBinder iBinder) {
                this.zzrk = iBinder;
            }
        ...
        public static zzb zzej(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof zzb)) ? new C0466zza(iBinder) : (zzb) queryLocalInterface;
        }
        ...
        public boolean onTransact(int i, Parcel parcel, Parcel parcel2, int i2) throws RemoteException {
            ...
            switch (i) {
                ...
                case 17:
                    parcel.enforceInterface("com.google.android.gms.maps.model.internal.ICircleDelegate");
                    boolean zzb = zzb(zzej(parcel.readStrongBinder()));
                    parcel2.writeNoException();
                    if (zzb) {
                        i5 = 1;
                    }

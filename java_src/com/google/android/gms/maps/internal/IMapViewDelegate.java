...
public interface IMapViewDelegate extends IInterface {
    ...
    public static abstract class zza extends Binder implements IMapViewDelegate {
        ...
        /* loaded from: classes2.dex */
        private static class C0425zza implements IMapViewDelegate {
            private IBinder zzrk;

            C0425zza(IBinder iBinder) {
                this.zzrk = iBinder;
            }
        ...
        public static IMapViewDelegate zzdy(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof IMapViewDelegate)) ? new C0425zza(iBinder) : (IMapViewDelegate) queryLocalInterface;
        }

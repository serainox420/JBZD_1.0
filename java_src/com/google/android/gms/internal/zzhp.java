...
public interface zzhp extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzhp {
        ...
        /* loaded from: classes2.dex */
        private static class C0344zza implements zzhp {
            private IBinder zzrk;

            C0344zza(IBinder iBinder) {
                this.zzrk = iBinder;
            }
        ...
        public static zzhp zzH(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof zzhp)) ? new C0344zza(iBinder) : (zzhp) queryLocalInterface;
        }
    ...
    void zza(zzhj zzhjVar) throws RemoteException;
}

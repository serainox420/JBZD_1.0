...
public interface zzvq extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzvq {
        ...
        /* loaded from: classes2.dex */
        private static class C0394zza implements zzvq {
            private IBinder zzrk;

            C0394zza(IBinder iBinder) {
                this.zzrk = iBinder;
            }
        ...
        public static zzvq zzaI(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof zzvq)) ? new C0394zza(iBinder) : (zzvq) queryLocalInterface;
        }
